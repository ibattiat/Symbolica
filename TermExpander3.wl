...
(****** TermExpander.wl -- Expand the dependent variables in a term.
*************)

(* 

TermExpander[term, spacial independent variables, spacial independent variable scales,
time independent variable, time independent variable scales] 

Given a term, expand the dependent variables in a power series of \[Epsilon].
...
BeginPackage["Disruptioneering`TermExpander`"];

TermExpander::usage = 
"TermExpander[term, dependent variables, spacial independent variables, spacial independent
variable scales, time independent variable, time independent variable scales]  Given a term,
expand the dependent variables in a power series of \[Epsilon].";



Begin["`Disruptioneering`"];

TermExpander[term_, termExpand_, epsilonAndOrder_, allVariables_, allRanks_, \
...
divform_, gradform_, normalvecform_, Uform_, slowIV_, fastIV_, option_] := 
    procedure[term, termExpand, epsilonAndOrder, allVariables, allRanks, \
...
procedure[term_, termExpand_, epsilonAndOrder_, allVariables_, allRanks_, closurevar_, graddenoters_, \
...
divform_, gradform_, normalvecform_, Uform_, slowIV_, fastIV_, option_] :=
    Block[{functionName = "TermExpander", solution, globalNewVariables = allVariables, globalNewRanks = allRanks},
        
        solution = main[Expand[term], termExpand, epsilonAndOrder, globalNewVariables, globalNewRanks, \
          closurevar, graddenoters, divdenoters, avgdenoters, derivativedenoters, \
          dotdenoters, tensorproductdenoters, doubledotdenoters, pietrzykflipdenoters, \
...
main[term_, termExpand_, epsilonAndOrder_, allVariables_, allRanks_, closurevar_, graddenoters_, \
divdenoters_, avgdenoters_, derivativedenoters_, dotdenoters_, tensorproductdenoters_, doubledotdenoters_, pietrzykflipdenoters_, \
divform_, gradform_, normalvecform_, Uform_, slowIV_, fastIV_, option_] :=
    Block[{solution},
        
        If[Head[term] == List,
            solution = caseListmain[term, termExpand, epsilonAndOrder, allVariables, allRanks, closurevar, \
              ...
              option];
            ,
            solution = caseNonListmain[term, termExpand, epsilonAndOrder, allVariables, allRanks, closurevar, \
              graddenoters, divdenoters, avgdenoters, derivativedenoters, dotdenoters, tensorproductdenoters, \
              doubledotdenoters, pietrzykflipdenoters, divform, gradform, normalvecform, Uform, slowIV, fastIV, \
              option];
            ,
...
caseListmain[term_, termExpand_, epsilonAndOrder_, allVariables_, allRanks_, closurevar_, graddenoters_, \
divdenoters_, avgdenoters_, derivativedenoters_, dotdenoters_, tensorproductdenoters_, doubledotdenoters_, pietrzykflipdenoters_, \
divform_, gradform_, normalvecform_, Uform_, slowIV_, fastIV_, option_] :=
    Block[{i, solution = ConstantArray[0, Length[term]]},
        
        For[i = 1, i <= Length[term], i++,
            solution[[i]] = main[term[[i]], termExpand, epsilonAndOrder, allVariables, allRanks, closurevar, \
              graddenoters, divdenoters, avgdenoters, derivativedenoters, dotdenoters, tensorproductdenoters, \
              doubledotdenoters, pietrzykflipdenoters, divform, gradform, normalvecform, Uform, slowIV, fastIV, \
              option];
        ];
...
caseNonListmain[term_, termExpand_, epsilonAndOrder_, allVariables_, allRanks_, closurevar_, graddenoters_, \
divdenoters_, avgdenoters_, derivativedenoters_, dotdenoters_, tensorproductdenoters_, doubledotdenoters_, pietrzykflipdenoters_, \
divform_, gradform_, normalvecform_, Uform_, slowIV_, fastIV_, option_] :=
    Block[{i, solution, solutionvec},
        ...
        If[Head[term] == Plus,
            ...
            For[i = 1, i <= Length[term], i++,
                solutionvec[[i]] = casePlusSubstituter[term[[i]], termExpand, epsilonAndOrder, allVariables, allRanks, \
                  closurevar, graddenoters, divdenoters, avgdenoters, derivativedenoters, \
            ...
            ,
            solution = casePlusSubstituter[term, termExpand, epsilonAndOrder, allVariables, allRanks, \
...
casePlusSubstituter[term_, termExpand_, epsilonAndOrder_, allVariables_, allRanks_, closurevar_, \
...
gradform_, normalvecform_, Uform_, slowIV_, fastIV_, option_] :=
    Block[{solution, levelcountdummy = 0, i},
        ...
        solution = decider[term, termExpand, epsilonAndOrder, allVariables, allRanks, closurevar, \
...
decider[term_, termExpand_, epsilonAndOrder_, allVariables_, allRanks_, closurevar_, graddenoters_, \
...
normalvecform_, Uform_, slowIV_, fastIV_, levelcountdummy_, option_] :=
    ...
    dependencies, i, flagsubscript = 0, printouttoggle = 0},
        ...
        If[levelcount == 1000,
            ...
            Print["CRITICAL ERROR: " <> functionName <> ": decider: Reached levelcount limit. Backing out."];
            ...
            If[Head[term] == List && chosen == 0,
                ...
                chosen = 1;
                dimlesscoef = caseList[term, termExpand, epsilonAndOrder, allVariables, allRanks, \
            ...
            If[Head[term] == Rational && chosen == 0,
                ...
                chosen = 1;
                dimlesscoef = caseRational[term, termExpand, epsilonAndOrder, allVariables, allRanks, \
                  closurevar, graddenoters, divdenoters, avgdenoters, derivativedenoters, dotdenoters, tensorproductdenoters, doubledotdenoters, pietrzykflipdenoters, \
            ...
            If[Head[term] == Integer && chosen == 0,
                ...
                chosen = 1;
                dimlesscoef = caseInteger[term, termExpand, epsilonAndOrder, allVariables, allRanks, \
                  closurevar, graddenoters, divdenoters, avgdenoters, derivativedenoters, dotdenoters, tensorproductdenoters, doubledotdenoters, pietrzykflipdenoters, \
                  divform, gradform, normalvecform, Uform, slowIV, fastIV, levelcountdummy, \
                  option];
            ];
            If[Head[term] == Symbol && chosen == 0,
                ...
                chosen = 1;
                dimlesscoef = caseSymbol[term, termExpand, epsilonAndOrder, allVariables, allRanks, \
                  closurevar, graddenoters, divdenoters, avgdenoters, derivativedenoters, dotdenoters, tensorproductdenoters, doubledotdenoters, pietrzykflipdenoters, \
                  divform, gradform, normalvecform, Uform, slowIV, fastIV, levelcountdummy, \
                  option];
            ];
            If[Head[term] == Head[pietrzykflipdenoters[[1]]] && chosen == 0,
                If[term[[2]] == pietrzykflipdenoters[[2]],
                    ...
                    chosen = 1;
                    dimlesscoef = casePietrzykFlip[term, termExpand, epsilonAndOrder, allVariables, allRanks, \
                      closurevar, graddenoters, divdenoters, avgdenoters, derivativedenoters, dotdenoters, tensorproductdenoters, doubledotdenoters, pietrzykflipdenoters, divform, \
                      gradform, normalvecform, Uform, slowIV, fastIV, levelcountdummy, option];
                ];
            ];
            If[Head[term] == Power && chosen == 0,
                ...
                chosen = 1;
                dimlesscoef = casePower[term, termExpand, epsilonAndOrder, allVariables, allRanks, \
                  closurevar, graddenoters, divdenoters, avgdenoters, derivativedenoters, dotdenoters, tensorproductdenoters, doubledotdenoters, pietrzykflipdenoters, divform, \
                  gradform, normalvecform, Uform, slowIV, fastIV, levelcountdummy, option];
            ];
            If[Head[term] == Head[derivativedenoters[[1]]] && chosen == 0,
                ...
                chosen = 1;
                dimlesscoef = caseDerivative[term, termExpand, epsilonAndOrder, allVariables, allRanks, \
                  closurevar, graddenoters, divdenoters, avgdenoters, derivativedenoters, dotdenoters, tensorproductdenoters, doubledotdenoters, pietrzykflipdenoters, \
                  divform, gradform, normalvecform, Uform, slowIV, fastIV, levelcountdummy, \
                  option];
            ];
            If[Head[term] == Times && chosen == 0,
                ...
                chosen = 1;
                dimlesscoef = caseTimes[term, termExpand, epsilonAndOrder, allVariables, allRanks, \
                  closurevar, graddenoters, divdenoters, avgdenoters, derivativedenoters, dotdenoters, tensorproductdenoters, doubledotdenoters, pietrzykflipdenoters, divform, \
                  gradform, normalvecform, Uform, slowIV, fastIV, levelcountdummy, option];
            ];
            If[Head[term] == Head[dotdenoters[[1]]] && chosen == 0,
                ...
                chosen = 1;
                dimlesscoef = caseDot[term, termExpand, epsilonAndOrder, allVariables, allRanks, \
                  closurevar, graddenoters, divdenoters, avgdenoters, derivativedenoters, dotdenoters, tensorproductdenoters, doubledotdenoters, pietrzykflipdenoters, divform, \
                  gradform, normalvecform, Uform, slowIV, fastIV, levelcountdummy, option];
            ];
            If[Head[term] == Head[tensorproductdenoters[[1]]] && chosen == 0,
                ...
                chosen = 1;
                dimlesscoef = caseTensorProduct[term, termExpand, epsilonAndOrder, allVariables, allRanks, \
                  closurevar, graddenoters, divdenoters, avgdenoters, derivativedenoters, dotdenoters, tensorproductdenoters, doubledotdenoters, pietrzykflipdenoters, \
                  divform, gradform, normalvecform, Uform, slowIV, fastIV, levelcountdummy, \
                  option];
            ];
            If[Head[term] == Head[doubledotdenoters[[1]]] && chosen == 0,
                ...
                chosen = 1;
                dimlesscoef = caseDoubleDot[term, termExpand, epsilonAndOrder, allVariables, allRanks, \
                  closurevar, graddenoters, divdenoters, avgdenoters, derivativedenoters, dotdenoters, \
                  tensorproductdenoters, doubledotdenoters, pietrzykflipdenoters, divform, gradform, normalvecform, \
            ...
            If[Head[term] == Plus && chosen == 0,
                ...
                chosen = 1;
                dimlesscoef = casePlus[term, termExpand, epsilonAndOrder, allVariables, allRanks, \
                  closurevar, graddenoters, divdenoters, avgdenoters, derivativedenoters, dotdenoters, tensorproductdenoters, doubledotdenoters, pietrzykflipdenoters, divform, \
                  gradform, normalvecform, Uform, slowIV, fastIV, levelcountdummy, option];
            ];
            If[Head[term] == Head[graddenoters[[1]]] && chosen == 0,
                ...
                chosen = 1;
                dimlesscoef = caseGradient[term, termExpand, epsilonAndOrder, allVariables, allRanks, \
                  closurevar, graddenoters, divdenoters, avgdenoters, derivativedenoters, dotdenoters, tensorproductdenoters, doubledotdenoters, pietrzykflipdenoters, \
                  divform, gradform, normalvecform, Uform, slowIV, fastIV, levelcountdummy, \
                  option];
            ];
            If[Head[term] == Head[divdenoters[[1]]] && chosen == 0,
                ...
                chosen = 1;
                dimlesscoef = caseDivergence[term, termExpand, epsilonAndOrder, allVariables, allRanks, \
                  closurevar, graddenoters, divdenoters, avgdenoters, derivativedenoters, dotdenoters, tensorproductdenoters, doubledotdenoters, pietrzykflipdenoters, \
                  divform, gradform, normalvecform, Uform, slowIV, fastIV, levelcountdummy, \
                  option];
            ];
            If[Head[term] == Head[avgdenoters[[1, 1]]] && chosen == 0,
                ...
                chosen = 1;
                dimlesscoef = caseAverage[term, termExpand, epsilonAndOrder, allVariables, allRanks, \
                  closurevar, graddenoters, divdenoters, avgdenoters, derivativedenoters, dotdenoters, tensorproductdenoters, doubledotdenoters, pietrzykflipdenoters, \
                  divform, gradform, normalvecform, Uform, slowIV, fastIV, levelcountdummy, \
                  option];
            ];
            ...
            If[chosen == 0,
                ...
                dimlesscoef = decider[Head[term], termExpand, epsilonAndOrder, allVariables, allRanks, \
                  closurevar, graddenoters, divdenoters, avgdenoters, derivativedenoters, dotdenoters, tensorproductdenoters, doubledotdenoters, pietrzykflipdenoters, \
                  divform, gradform, normalvecform, Uform, slowIV, fastIV, levelcountdummy, \
                  dependencies];
            ];
...
(*Ready*)
caseList[term_, termExpand_, epsilonAndOrder_, allVariables_, allRanks_, closurevar_, graddenoters_, \
divdenoters_, avgdenoters_, derivativedenoters_, dotdenoters_, tensorproductdenoters_, doubledotdenoters_, pietrzykflipdenoters_, \
...
(*Ready*)
caseRational[term_, termExpand_, epsilonAndOrder_, allVariables_, allRanks_, closurevar_, graddenoters_, \
divdenoters_, avgdenoters_, derivativedenoters_, dotdenoters_, tensorproductdenoters_, doubledotdenoters_, pietrzykflipdenoters_, \
divform_, gradform_, normalvecform_, Uform_, slowIV_, fastIV_, levelcountdummy_, option_] :=
...
(*Ready*)
caseInteger[term_, termExpand_, epsilonAndOrder_, allVariables_, allRanks_, closurevar_, graddenoters_, \
divdenoters_, avgdenoters_, derivativedenoters_, dotdenoters_, tensorproductdenoters_, doubledotdenoters_, pietrzykflipdenoters_, \
divform_, gradform_, normalvecform_, Uform_, slowIV_, fastIV_, levelcountdummy_, option_] :=
    Block[{dimlesscoef = term},
        Return[dimlesscoef];
...
(*Ready*)
caseSymbol[term_, termExpand_, epsilonAndOrder_, allVariables_, allRanks_, closurevar_, graddenoters_, \
divdenoters_, avgdenoters_, derivativedenoters_, dotdenoters_, tensorproductdenoters_, doubledotdenoters_, pietrzykflipdenoters_, \
divform_, gradform_, normalvecform_, Uform_, slowIV_, fastIV_, levelcountdummy_, option_] :=
    Block[{dimlesscoef, i, ii, scalvecten = -1},
        
        dimlesscoef = dependencyadder[term, option];
        
        For[i = 1, i <= Length[termExpand], i++,
            If[termExpand[[i]] == term,
                For[ii = 1, ii <= Length[allVariables], ii++,
                    If[allVariables[[ii]] == term,
                        dimlesscoef = seriesexpansion[term, option, allRanks[[ii]], epsilonAndOrder[[1]], epsilonAndOrder[[2]]];
                        Break[];
                    ];
                ];
                Break[];
...
(*Ready*)
casePietrzykFlip[term_, termExpand_, epsilonAndOrder_, allVariables_, allRanks_, closurevar_, graddenoters_, \
divdenoters_, avgdenoters_, derivativedenoters_, dotdenoters_, tensorproductdenoters_, doubledotdenoters_, pietrzykflipdenoters_, \
divform_, gradform_, normalvecform_, Uform_, slowIV_, fastIV_, levelcountdummy_, option_] :=
    Block[{dimlesscoef, argument = term[[1]], superscript = term[[2]], inthepower, i, \
    expandedargument, expandedinthepower, bracketeddummy},
        ...
        If[Head[expandedargument] == Plus,
            ...
            For[i = 1, i <= Length[expandedargument], i++,
                bracketeddummy = OperatorApplier[expandedargument[[i]], pietrzykflipdenoters, \
                  superscript];
                dimlesscoef += decider[bracketeddummy, termExpand, epsilonAndOrder, allVariables, allRanks, \
                  closurevar, graddenoters, divdenoters, avgdenoters, derivativedenoters, dotdenoters, \
                  tensorproductdenoters, doubledotdenoters, pietrzykflipdenoters, divform, gradform, normalvecform, \
                  Uform, slowIV, fastIV, levelcountdummy, option];
            ];
        ...
        inthepower = decider[argument, termExpand, epsilonAndOrder, allVariables, allRanks, \
          closurevar, graddenoters, divdenoters, avgdenoters, derivativedenoters, dotdenoters, tensorproductdenoters, doubledotdenoters, pietrzykflipdenoters, \
          divform, gradform, normalvecform, Uform, slowIV, fastIV, levelcountdummy, \
          option];
        
        expandedinthepower = Expand[inthepower];
        
        If[Head[expandedinthepower] == Plus,
            dimlesscoef = 0;
            For[i = 1, i <= Length[expandedinthepower], i++,
                dimlesscoef += OperatorApplier[expandedinthepower[[i]], \
                  pietrzykflipdenoters, superscript];
            ];
            ,
            dimlesscoef = OperatorApplier[expandedinthepower, \
              pietrzykflipdenoters, superscript];
            ,
            dimlesscoef = OperatorApplier[expandedinthepower, \
              pietrzykflipdenoters, superscript];
...
(*Ready*)
casePower[term_, termExpand_, epsilonAndOrder_, allVariables_, allRanks_, closurevar_, graddenoters_, \
divdenoters_, avgdenoters_, derivativedenoters_, dotdenoters_, tensorproductdenoters_, doubledotdenoters_, pietrzykflipdenoters_, \
divform_, gradform_, normalvecform_, Uform_, slowIV_, fastIV_, levelcountdummy_, option_] :=
    Block[{dimlesscoef, argument = term[[1]], power = term[[2]], inthepower, i, \
    expandedterm = Expand[term], expandedargument, expandedinthepower, \
    dimlesscoefparts, bracketeddummy},
        
        If[Head[expandedterm] == Plus,
            
            dimlesscoef = decider[expandedterm, termExpand, epsilonAndOrder, allVariables, allRanks, \
              closurevar, graddenoters, divdenoters, avgdenoters, derivativedenoters, dotdenoters, \
              tensorproductdenoters, doubledotdenoters, pietrzykflipdenoters, divform, gradform, normalvecform, \
              Uform, slowIV, fastIV, levelcountdummy, option];
        ...
        If[Head[expandedinthepower] == Plus,
            If[power >= 0,
                dimlesscoef = Expand[expandedinthepower^power];
                ,
                dimlesscoef = casePowerSimp[expandedinthepower^power, termExpand, epsilonAndOrder, allVariables, allRanks, closurevar, graddenoters, \
                  divdenoters, avgdenoters, derivativedenoters, dotdenoters, tensorproductdenoters, doubledotdenoters, pietrzykflipdenoters, \
                  divform, gradform, normalvecform, Uform, slowIV, fastIV, levelcountdummy, option];
            ];
            ,
            dimlesscoef = expandedinthepower^power;
            ,
            dimlesscoef = expandedinthepower^power;
        ];
...
(*Ready*)
casePowerSimp[term_, termExpand_, epsilonAndOrder_, allVariables_, allRanks_, closurevar_, graddenoters_, \
divdenoters_, avgdenoters_, derivativedenoters_, dotdenoters_, tensorproductdenoters_, doubledotdenoters_, pietrzykflipdenoters_, \
divform_, gradform_, normalvecform_, Uform_, slowIV_, fastIV_, levelcountdummy_, option_] :=
    Block[{dimlesscoef = {}, i, ii, iii, expandedargument, expandedinthepower, \
    dimlesscoefparts, bracketeddummy, newargument, dependencies, flag, dummy},
        
        dimlesscoef = 0;
        For[i = 0, i <= epsilonAndOrder[[2]], i++,
            dummy = D[term, {epsilonAndOrder[[1]], i}] /. epsilonAndOrder[[1]] -> 0;
            dimlesscoef += 1/Factorial[i] * epsilonAndOrder[[1]]^i * dummy;
        ];
...
(*Ready*)
caseDerivative[term_, termExpand_, epsilonAndOrder_, allVariables_, allRanks_, closurevar_, graddenoters_, \
...
levelcountdummy_, option_] :=
    Block[{dimlesscoef, argument = term[[1]], subscript = term[[2]], newargument, \
    i, expandedargument, bracketeddummy, expandednewargument},
        ...
        If[Head[expandedargument] == Plus,
            dimlesscoef = 0;
            For[i = 1, i <= Length[expandedargument], i++,
                bracketeddummy = OperatorApplier[expandedargument[[i]], derivativedenoters, subscript];
                dimlesscoef += decider[bracketeddummy, termExpand, epsilonAndOrder, allVariables, allRanks, \
                  closurevar, graddenoters, divdenoters, avgdenoters, derivativedenoters, dotdenoters, \
                  tensorproductdenoters, doubledotdenoters, pietrzykflipdenoters, divform, gradform, normalvecform, \
                  Uform, slowIV, fastIV, levelcountdummy, option];
        ...
        newargument = decider[expandedargument, termExpand, epsilonAndOrder, allVariables, allRanks, \
          closurevar, graddenoters, divdenoters, avgdenoters, derivativedenoters, dotdenoters, tensorproductdenoters, doubledotdenoters, pietrzykflipdenoters, \
          divform, gradform, normalvecform, Uform, slowIV, fastIV, levelcountdummy, \
          option];
        
        expandednewargument = Expand[newargument];
        
        If[Head[expandednewargument] == Plus,
            dimlesscoef = 0;
            For[i = 1, i <= Length[expandednewargument], i++,
                dimlesscoef += OperatorApplier[expandednewargument[[i]], derivativedenoters, subscript];
            ];
            ,
            dimlesscoef = OperatorApplier[expandednewargument, derivativedenoters, subscript];
            ,
            dimlesscoef = OperatorApplier[expandednewargument, derivativedenoters, subscript];
        ];
        
        dimlesscoef = getterminfo[dimlesscoef, {}, globalNewVariables, globalNewRanks, closurevar, graddenoters, \
          divdenoters, avgdenoters, derivativedenoters, dotdenoters, tensorproductdenoters, doubledotdenoters, pietrzykflipdenoters, \
          divform, gradform, normalvecform, Uform, slowIV, fastIV, levelcountdummy, option, {}];
        
        dimlesscoef = MakeSingleTerm[dimlesscoef, {}, dotdenoters, tensorproductdenoters, \
          doubledotdenoters];
        
        dimlesscoef = dimlesscoef[[1, 1, 1]];
...
(*Ready*)
caseTimes[term_, termExpand_, epsilonAndOrder_, allVariables_, allRanks_, closurevar_, graddenoters_, \
...
slowIV_, fastIV_, levelcountdummy_, option_] :=
    Block[{dimlesscoef, expandedterm = Expand[term], i, j, newterm},
        ...
        newterm = ConstantArray[0, Length[expandedterm]];
        For[i = 1, i <= Length[expandedterm], i++,
            newterm[[i]] = decider[expandedterm[[i]], termExpand, epsilonAndOrder, allVariables, allRanks, \
              closurevar, graddenoters, divdenoters, avgdenoters, derivativedenoters, dotdenoters, tensorproductdenoters, doubledotdenoters, pietrzykflipdenoters, \
              divform, gradform, normalvecform, Uform, slowIV, fastIV, levelcountdummy, \
              option];
        ];
        dimlesscoef = Expand[listProduct[newterm]];
...
(*Ready*)
caseDot[term_, termExpand_, epsilonAndOrder_, allVariables_, allRanks_, closurevar_, graddenoters_, \
divdenoters_, avgdenoters_, derivativedenoters_, dotdenoters_, tensorproductdenoters_, doubledotdenoters_, pietrzykflipdenoters_, divform_, gradform_, normalvecform_, Uform_, \
slowIV_, fastIV_, levelcountdummy_, option_] :=
    Block[{dimlesscoef, Nterms = Length[term], i, ii, iii, distributeddot, \
    expandedterm, newtermdotted, newterm},
        ...
        newterm = ConstantArray[0, Nterms];
        For[i = 1, i <= Nterms, i++,
            newterm[[i]] = decider[term[[i]], termExpand, epsilonAndOrder, allVariables, allRanks, \
              closurevar, graddenoters, divdenoters, avgdenoters, derivativedenoters, dotdenoters, tensorproductdenoters, doubledotdenoters, pietrzykflipdenoters, \
              divform, gradform, normalvecform, Uform, slowIV, fastIV, levelcountdummy, \
              option];
        ];
        
        (*Dot the components of newterm*)
        For[i = 1, i <= Length[newterm], i++,
            If[i == 1,
                newtermdotted = newterm[[i]]
                ,
                newtermdotted = OperatorApplier[newtermdotted, dotdenoters, newterm[[i]]];
            ];
        ];
        
        dimlesscoef = productDistributer[newtermdotted, dotdenoters, termExpand, epsilonAndOrder, allVariables, allRanks, closurevar, graddenoters, \
          divdenoters, avgdenoters, derivativedenoters, dotdenoters, tensorproductdenoters, doubledotdenoters, pietrzykflipdenoters, divform, gradform, normalvecform, Uform, \
...
productDistributer[term_, distributedDenoter_, termExpand_, epsilonAndOrder_, allVariables_, allRanks_, closurevar_, graddenoters_, \
divdenoters_, avgdenoters_, derivativedenoters_, dotdenoters_, tensorproductdenoters_, doubledotdenoters_, pietrzykflipdenoters_, divform_, gradform_, normalvecform_, Uform_, \
slowIV_, fastIV_, levelcountdummy_, option_] :=
    Block[{dimlesscoef, i, ii, iii, isum, j, flag = 0, expandedterm, distributeddot, Nsum},
        
        If[Head[term] == Plus,
            flag = 1;
            Nsum = Length[term];
            For[isum = 1, isum <= Nsum, isum++,
                
                For[i = 1, i <= Length[term[[isum]]], i++,
                    If[Head[term[[isum, i]]] == Plus,
                        expandedterm = 0;
                        For[ii = 1, ii <= Length[term[[isum, i]]], ii++,
                            For[iii = 1, iii <= Length[term[[isum]]], iii++,
                                If[iii == 1,
                                    If[iii == i,
                                        distributeddot = term[[isum, iii, ii]];
                                        ,
                                        distributeddot = term[[isum, iii]];
                                    ];
                                    ,
                                    If[iii == i,
                                        distributeddot = OperatorApplier[distributeddot, distributedDenoter, \
                                          term[[isum, iii, ii]]];
                                        ,
                                        distributeddot = OperatorApplier[distributeddot, distributedDenoter, \
                                          term[[isum, iii]]];
                        ...
                        (*Add other summed components in the term*)
                        For[j = 1, j <= Nsum, j++,
                            If[j == isum,
                                ,
                                expandedterm += term[[j]];
                        ...
                        dimlesscoef = productDistributer[expandedterm, distributedDenoter, termExpand, epsilonAndOrder, allVariables, allRanks, \
                          closurevar, graddenoters, divdenoters, avgdenoters, derivativedenoters, dotdenoters, \
                          tensorproductdenoters, doubledotdenoters, pietrzykflipdenoters, divform, gradform, normalvecform, \
                          Uform, slowIV, fastIV, levelcountdummy, option];
...
(*Ready*)
caseTensorProduct[term_, termExpand_, epsilonAndOrder_, allVariables_, allRanks_, closurevar_, graddenoters_, \
divdenoters_, avgdenoters_, derivativedenoters_, dotdenoters_, tensorproductdenoters_, doubledotdenoters_, pietrzykflipdenoters_, \
divform_, gradform_, normalvecform_, Uform_, slowIV_, fastIV_, levelcountdummy_, option_] :=
    Block[{dimlesscoef, Nterms = Length[term], i, ii, iii, distributedtensor, \
    expandedterm, newtermdotted, newterm},
        ...
        (*Tensorproduct the components of newterm*)
        For[i = 1, i <= Length[newterm], i++,
            If[i == 1,
                newtermdotted = newterm[[i]]
                ,
                newtermdotted = OperatorApplier[newtermdotted, tensorproductdenoters, newterm[[i]]];
            ];
        ];
        
        dimlesscoef = productDistributer[newtermdotted, tensorproductdenoters, termExpand, epsilonAndOrder, allVariables, allRanks, closurevar, graddenoters, \
          divdenoters, avgdenoters, derivativedenoters, dotdenoters, tensorproductdenoters, doubledotdenoters, pietrzykflipdenoters, divform, gradform, normalvecform, Uform, \
          slowIV, fastIV, levelcountdummy, option];
...
(*Ready*)
caseDoubleDot[term_, termExpand_, epsilonAndOrder_, allVariables_, allRanks_, closurevar_, graddenoters_, \
divdenoters_, avgdenoters_, derivativedenoters_, dotdenoters_, tensorproductdenoters_, doubledotdenoters_, pietrzykflipdenoters_, \
divform_, gradform_, normalvecform_, Uform_, slowIV_, fastIV_, levelcountdummy_, option_] :=
    Block[{dimlesscoef, Nterms = Length[term], i, ii, iii, distributeddoubledot, \
    expandedterm, newtermdotted, newterm},
        ...
        (*Doubledot the components of newterm*)
        For[i = 1, i <= Length[newterm], i++,
            If[i == 1,
                newtermdotted = newterm[[i]]
                ,
                newtermdotted = OperatorApplier[newtermdotted, doubledotdenoters, newterm[[i]]];
            ];
        ];
        
        dimlesscoef = productDistributer[newtermdotted, doubledotdenoters, termExpand, epsilonAndOrder, allVariables, allRanks, closurevar, graddenoters, \
          divdenoters, avgdenoters, derivativedenoters, dotdenoters, tensorproductdenoters, doubledotdenoters, pietrzykflipdenoters, divform, gradform, normalvecform, Uform, \
          slowIV, fastIV, levelcountdummy, option];
...
(*Ready*)
casePlus[term_, termExpand_, epsilonAndOrder_, allVariables_, allRanks_, closurevar_, graddenoters_, \
divdenoters_, avgdenoters_, derivativedenoters_, dotdenoters_, tensorproductdenoters_, doubledotdenoters_, pietrzykflipdenoters_, \
divform_, gradform_, normalvecform_, Uform_, slowIV_, fastIV_, levelcountdummy_, option_] :=
    Block[{dimlesscoef = 0, i},
        
        For[i = 1, i <= Length[term], i++,
            dimlesscoef += decider[term[[i]], termExpand, epsilonAndOrder, allVariables, allRanks, closurevar, \
              graddenoters, divdenoters, avgdenoters, derivativedenoters, dotdenoters, tensorproductdenoters, doubledotdenoters, pietrzykflipdenoters, divform, gradform, \
...
(*Ready*)
caseGradient[term_, termExpand_, epsilonAndOrder_, allVariables_, allRanks_, closurevar_, graddenoters_, \
divdenoters_, avgdenoters_, derivativedenoters_, dotdenoters_, tensorproductdenoters_, doubledotdenoters_, pietrzykflipdenoters_, \
divform_, gradform_, normalvecform_, Uform_, slowIV_, fastIV_, levelcountdummy_, option_] :=
    Block[{dimlesscoef, argument = term[[1]], subscript = term[[2]], newargument, \
    i, expandedargument, bracketeddummy, expandednewargument},
        ...
        If[Head[expandedargument] == Plus,
            dimlesscoef = 0;
            For[i = 1, i <= Length[expandedargument], i++,
                bracketeddummy = OperatorApplier[expandedargument[[i]], graddenoters, subscript];
                dimlesscoef += decider[bracketeddummy, termExpand, epsilonAndOrder, allVariables, allRanks, \
                  closurevar, graddenoters, divdenoters, avgdenoters, derivativedenoters, dotdenoters, \
                  tensorproductdenoters, doubledotdenoters, pietrzykflipdenoters, divform, gradform, normalvecform, \
                  Uform, slowIV, fastIV, levelcountdummy, option];
        ...
        If[Head[expandednewargument] == Plus,
            dimlesscoef = 0;
            For[i = 1, i <= Length[expandednewargument], i++,
                dimlesscoef += OperatorApplier[expandednewargument[[i]], graddenoters, subscript];
            ];
            ,
            dimlesscoef = OperatorApplier[expandednewargument, graddenoters, subscript];
            ,
            dimlesscoef = OperatorApplier[expandednewargument, graddenoters, subscript];
        ];
        
        (*Take scalars out of the derivatives, gradients, and divergences, \
        but do not simplify the derivatives*)
        dimlesscoef = getterminfo[dimlesscoef, {}, globalNewVariables, globalNewRanks, closurevar, graddenoters, \
          divdenoters, avgdenoters, derivativedenoters, dotdenoters, tensorproductdenoters, doubledotdenoters, pietrzykflipdenoters, \
          divform, gradform, normalvecform, Uform, slowIV, fastIV, levelcountdummy, option, {}];
...
(*Ready*)
caseDivergence[term_, termExpand_, epsilonAndOrder_, allVariables_, allRanks_, closurevar_, graddenoters_, \
divdenoters_, avgdenoters_, derivativedenoters_, dotdenoters_, tensorproductdenoters_, doubledotdenoters_, pietrzykflipdenoters_, divform_, gradform_, normalvecform_, Uform_, \
slowIV_, fastIV_, levelcountdummy_, option_] :=
    Block[{dimlesscoef, argument = term[[1]], subscript = term[[2]], newargument, \
    i, expandedargument, bracketeddummy, expandednewargument},
        ...
        If[Head[expandedargument] == Plus,
            dimlesscoef = 0;
            For[i = 1, i <= Length[expandedargument], i++,
                bracketeddummy = OperatorApplier[expandedargument[[i]], divdenoters, subscript];
                dimlesscoef += decider[bracketeddummy, termExpand, epsilonAndOrder, allVariables, allRanks, \
                  closurevar, graddenoters, divdenoters, avgdenoters, derivativedenoters, dotdenoters, \
                  tensorproductdenoters, doubledotdenoters, pietrzykflipdenoters, divform, gradform, normalvecform, \
                  Uform, slowIV, fastIV, levelcountdummy, option];
        ...
        If[Head[expandednewargument] == Plus,
            dimlesscoef = 0;
            For[i = 1, i <= Length[expandednewargument], i++,
                dimlesscoef += OperatorApplier[expandednewargument[[i]], divdenoters, subscript];
            ];
            ,
            dimlesscoef = OperatorApplier[expandednewargument, divdenoters, subscript];
            ,
            dimlesscoef = OperatorApplier[expandednewargument, divdenoters, subscript];
        ];
...
(*Ready*)
caseAverage[term_, termExpand_, epsilonAndOrder_, allVariables_, allRanks_, closurevar_, graddenoters_, \
divdenoters_, avgdenoters_, derivativedenoters_, dotdenoters_, tensorproductdenoters_, doubledotdenoters_, pietrzykflipdenoters_, divform_, gradform_, normalvecform_, Uform_, \
slowIV_, fastIV_, levelcountdummy_, option_] :=
    Block[{dimlesscoef, argument = term[[1, 1]], subscript = term[[2]], newargument, \
    flag = 0, argumentparts, i, j, expandedargument, bracketeddummy, expandednewargument},
        ...
        If[Head[expandedargument] == Plus,
            dimlesscoef = 0;
            For[i = 1, i <= Length[expandedargument], i++,
                bracketeddummy = OperatorApplier[expandedargument[[i]], avgdenoters[[1]], subscript];
                dimlesscoef += decider[bracketeddummy, termExpand, epsilonAndOrder, allVariables, allRanks, \
                  closurevar, graddenoters, divdenoters, avgdenoters, derivativedenoters, dotdenoters, \
                  tensorproductdenoters, doubledotdenoters, pietrzykflipdenoters, divform, gradform, normalvecform, \
                  Uform, slowIV, fastIV, levelcountdummy, option];
        ...
        If[Head[expandednewargument] == Plus,
            dimlesscoef = 0;
            For[i = 1, i <= Length[expandednewargument], i++,
                dimlesscoef += OperatorApplier[expandednewargument[[i]], avgdenoters[[1]], subscript];
            ];
            ,
            dimlesscoef = OperatorApplier[expandednewargument, avgdenoters[[1]], subscript];
            ,
            dimlesscoef = OperatorApplier[expandednewargument, avgdenoters[[1]], subscript];
        ];
        
        (*Take scalars out of the average, but do not simplify the derivatives*)
        dimlesscoef = getterminfo[dimlesscoef, {}, globalNewVariables, globalNewRanks, closurevar, graddenoters, \
          divdenoters, avgdenoters, derivativedenoters, dotdenoters, tensorproductdenoters, doubledotdenoters, pietrzykflipdenoters, \
          divform, gradform, normalvecform, Uform, slowIV, fastIV, levelcountdummy, option, {}];
...
seriesexpansion[a_, IV_, rank_, \[Epsilon]_, N_] :=
    Block[{i, j, dummy2, dummy2nIV, solution = 0},
        For[i = 0, i <= N, i++,
            dummy2 = ToString[a] <> ToString[i];
            dummy2nIV = dummy2;
            If[Length[IV] > 0,
            ...
            solution += \[Epsilon]^i * ToExpression[dummy2];
            
            globalNewVariables = Join[globalNewVariables, {ToExpression[dummy2nIV]}];
            globalNewRanks = Join[globalNewRanks, {rank}];
        ];
...
(*Checked*)
getterminfo[term_, isdependenton_, allVariables_, allRanks_, closurevar_, graddenoters_, \
divdenoters_, avgdenoters_, derivativedenoters_, dotdenoters_, tensorproductdenoters_, doubledotdenoters_, pietrzykflipdenoters_, \
divform_, gradform_, normalvecform_, Uform_, slowIV_, fastIV_, levelcountdummy_, option_, option2_] :=
    ...
    globalSimplificationDivergences = {"Distribute Divergences"}},
        ...
        dimlesscoef = getterminfo[term, isdependenton, allVariables, allRanks, closurevar, graddenoters, \
    ...
    dependencies, i, flagsubscript = 0, printouttoggle = 0},
        ...
        If[levelcount == 1000,
            ...
            If[Head[term] == List && chosen == 0,
                ...
                chosen = 1;
                dimlesscoef = subsubcaseList[term, isdependenton, allVariables, allRanks, \
                  closurevar, graddenoters, divdenoters, avgdenoters, derivativedenoters, dotdenoters, \
                  tensorproductdenoters, doubledotdenoters, pietrzykflipdenoters, divform, gradform, normalvecform, \
            ...
            If[Head[term] == Rational && chosen == 0,
                ...
                chosen = 1;
                dimlesscoef = subsubcaseRational[term, isdependenton, allVariables, allRanks, \
                  closurevar, graddenoters, divdenoters, avgdenoters, derivativedenoters, dotdenoters, \
                  tensorproductdenoters, doubledotdenoters, pietrzykflipdenoters, divform, gradform, normalvecform, \
                  Uform, slowIV, fastIV, levelcount, option];
            ];
            If[Head[term] == Integer && chosen == 0,
                ...
                chosen = 1;
                dimlesscoef = subsubcaseInteger[term, isdependenton, allVariables, allRanks, \
                  closurevar, graddenoters, divdenoters, avgdenoters, derivativedenoters, dotdenoters, \
                  tensorproductdenoters, doubledotdenoters, pietrzykflipdenoters, divform, gradform, normalvecform, \
                  Uform, slowIV, fastIV, levelcount, option];
            ];
            If[Head[term] == Symbol && chosen == 0,
                ...
                chosen = 1;
                dimlesscoef = subsubcaseSymbol[term, isdependenton, allVariables, allRanks, \
                  closurevar, graddenoters, divdenoters, avgdenoters, derivativedenoters, dotdenoters, \
                  tensorproductdenoters, doubledotdenoters, pietrzykflipdenoters, divform, gradform, normalvecform, \
                  Uform, slowIV, fastIV, levelcount, option];
            ];
            If[Head[term] == Head[pietrzykflipdenoters[[1]]] && chosen == 0,
                If[term[[2]] == pietrzykflipdenoters[[2]],
                    ...
                    chosen = 1;
                    dimlesscoef = subsubcasePietrzykFlip[term, isdependenton, allVariables, allRanks, \
            ...
            If[Head[term] == Power && chosen == 0,
                ...
                chosen = 1;
                dimlesscoef = subsubcasePower[term, isdependenton, allVariables, allRanks, \
                  closurevar, graddenoters, divdenoters, avgdenoters, derivativedenoters, dotdenoters, \
                  tensorproductdenoters, doubledotdenoters, pietrzykflipdenoters, divform, gradform, normalvecform, \
                  Uform, slowIV, fastIV, levelcount, option];
            ];
            If[Head[term] == Head[derivativedenoters[[1]]] && chosen == 0,
                ...
                chosen = 1;
                dimlesscoef = subsubcaseDerivative[term, isdependenton, allVariables, allRanks, \
                  closurevar, graddenoters, divdenoters, avgdenoters, derivativedenoters, dotdenoters, \
                  tensorproductdenoters, doubledotdenoters, pietrzykflipdenoters, divform, gradform, normalvecform, \
                  Uform, slowIV, fastIV, levelcount, option];
            ];
            If[Head[term] == Times && chosen == 0,
                ...
                chosen = 1;
                dimlesscoef = subsubcaseTimes[term, isdependenton, allVariables, allRanks, \
                  closurevar, graddenoters, divdenoters, avgdenoters, derivativedenoters, dotdenoters, \
                  tensorproductdenoters, doubledotdenoters, pietrzykflipdenoters, divform, gradform, normalvecform, \
                  Uform, slowIV, fastIV, levelcount, option];
            ];
            If[Head[term] == Head[dotdenoters[[1]]] && chosen == 0,
                ...
                chosen = 1;
                dimlesscoef = subsubcaseDot[term, isdependenton, allVariables, allRanks, \
                  closurevar, graddenoters, divdenoters, avgdenoters, derivativedenoters, dotdenoters, \
                  tensorproductdenoters, doubledotdenoters, pietrzykflipdenoters, divform, gradform, normalvecform, \
                  Uform, slowIV, fastIV, levelcount, option];
            ];
            If[Head[term] == Head[tensorproductdenoters[[1]]] && chosen == 0,
                ...
                chosen = 1;
                dimlesscoef = subsubcaseTensorProduct[term, isdependenton, allVariables, allRanks, \
                  closurevar, graddenoters, divdenoters, avgdenoters, derivativedenoters, dotdenoters, \
                  tensorproductdenoters, doubledotdenoters, pietrzykflipdenoters, divform, gradform, normalvecform, \
                  Uform, slowIV, fastIV, levelcount, option];
            ];
            If[Head[term] == Head[doubledotdenoters[[1]]] && chosen == 0,
                ...
                chosen = 1;
                dimlesscoef = subsubcaseDoubleDot[term, isdependenton, allVariables, allRanks, \
                  closurevar, graddenoters, divdenoters, avgdenoters, derivativedenoters, dotdenoters, \
                  tensorproductdenoters, doubledotdenoters, pietrzykflipdenoters, divform, gradform, normalvecform, \
                  Uform, slowIV, fastIV, levelcount, option];
            ];
            If[Head[term] == Plus && chosen == 0,
                ...
                chosen = 1;
                dimlesscoef = subsubcasePlus[term, isdependenton, allVariables, allRanks, \
                  closurevar, graddenoters, divdenoters, avgdenoters, derivativedenoters, dotdenoters, \
                  tensorproductdenoters, doubledotdenoters, pietrzykflipdenoters, divform, gradform, normalvecform, \
                  Uform, slowIV, fastIV, levelcount, option];
            ];
            If[Head[term] == Head[graddenoters[[1]]] && chosen == 0,
                ...
                chosen = 1;
                dimlesscoef = subsubcaseGradient[term, isdependenton, allVariables, allRanks, \
                  closurevar, graddenoters, divdenoters, avgdenoters, derivativedenoters, dotdenoters, \
                  tensorproductdenoters, doubledotdenoters, pietrzykflipdenoters, divform, gradform, normalvecform, \
                  Uform, slowIV, fastIV, levelcount, option];
            ];
            If[Head[term] == Head[divdenoters[[1]]] && chosen == 0,
                ...
                chosen = 1;
                dimlesscoef = subsubcaseDivergence[term, isdependenton, allVariables, allRanks, \
                  closurevar, graddenoters, divdenoters, avgdenoters, derivativedenoters, dotdenoters, \
                  tensorproductdenoters, doubledotdenoters, pietrzykflipdenoters, divform, gradform, normalvecform, \
                  Uform, slowIV, fastIV, levelcount, option];
            ];
            If[Head[term] == Head[avgdenoters[[1, 1]]] && chosen == 0,
                ...
                chosen = 1;
                dimlesscoef = subsubcaseAverage[term, isdependenton, allVariables, allRanks, \
                  closurevar, graddenoters, divdenoters, avgdenoters, derivativedenoters, dotdenoters, \
                  tensorproductdenoters, doubledotdenoters, pietrzykflipdenoters, divform, gradform, normalvecform, \
                  Uform, slowIV, fastIV, levelcount, option];
            ];
            ...
            If[chosen == 0,
                ...
                dimlesscoef = getterminfo[Head[term], isdependenton, allVariables, allRanks, \
                  closurevar, graddenoters, divdenoters, avgdenoters, derivativedenoters, dotdenoters, \
                  tensorproductdenoters, doubledotdenoters, pietrzykflipdenoters, divform, gradform, normalvecform, \
...
(*Checked*)
subsubcaseList[term_, isdependenton_, allVariables_, allRanks_, closurevar_, \
...
(*Checked*)
subsubcaseRational[term_, isdependenton_, allVariables_, allRanks_, closurevar_, \
graddenoters_, divdenoters_, avgdenoters_, derivativedenoters_, dotdenoters_, tensorproductdenoters_, doubledotdenoters_, pietrzykflipdenoters_, divform_, gradform_, normalvecform_, \
Uform_, slowIV_, fastIV_, levelcountdummy_, option_] :=
...
(*Checked*)
subsubcaseInteger[term_, isdependenton_, allVariables_, allRanks_, closurevar_, \
graddenoters_, divdenoters_, avgdenoters_, derivativedenoters_, dotdenoters_, tensorproductdenoters_, doubledotdenoters_, pietrzykflipdenoters_, divform_, gradform_, normalvecform_, \
Uform_, slowIV_, fastIV_, levelcountdummy_, option_] :=
    Block[{dimlesscoef = {{{term}, {0}, {0}}}},
        Return[dimlesscoef];
...
(*Checked*)
subsubcaseSymbol[term_, isdependenton_, allVariables_, allRanks_, closurevar_, \
graddenoters_, divdenoters_, avgdenoters_, derivativedenoters_, dotdenoters_, tensorproductdenoters_, doubledotdenoters_, pietrzykflipdenoters_, divform_, gradform_, normalvecform_, \
Uform_, slowIV_, fastIV_, levelcountdummy_, option_] :=
    Block[{dimlesscoef = {{{}, {}, {}}}, i, j, term2, \
    dummy = ConstantArray[0, Length[isdependenton]], scalvecten = -1},
        ...
        (*Get the tensor rank*)
        For[i = 1, i <= Length[allVariables], i++,
            If[allVariables[[i]] == term,
                scalvecten = allRanks[[i]];
                Break[];
            ];
        ];
        If[scalvecten == -1,
...
(*Checked*)
subsubcasePietrzykFlip[term_, isdependenton_, allVariables_, allRanks_, closurevar_, \
graddenoters_, divdenoters_, avgdenoters_, derivativedenoters_, dotdenoters_, tensorproductdenoters_, doubledotdenoters_, pietrzykflipdenoters_, divform_, gradform_, normalvecform_, \
Uform_, slowIV_, fastIV_, levelcountdummy_, option_] :=
    ...
    dimlesscoefparts, bracketeddummy, iii, dummy, scalarmults = {{{}, {}, {}}}},
        ...
        If[Head[expandedterm] == Plus,
            For[i = 1, i <= Length[expandedterm], i++,
                ...
                dimlesscoefparts = getterminfo[bracketeddummy, isdependenton, allVariables, allRanks, \
                  closurevar, graddenoters, divdenoters, avgdenoters, derivativedenoters, \
                  dotdenoters, tensorproductdenoters, doubledotdenoters, pietrzykflipdenoters, divform, gradform, \
                  normalvecform, Uform, slowIV, fastIV, levelcountdummy, option];
        ...
        inthepower = getterminfo[argument, isdependenton, allVariables, allRanks, \
...
(*Checked*)
subsubcasePower[term_, isdependenton_, allVariables_, allRanks_, closurevar_, \
graddenoters_, divdenoters_, avgdenoters_, derivativedenoters_, dotdenoters_, tensorproductdenoters_, doubledotdenoters_, pietrzykflipdenoters_, divform_, gradform_, normalvecform_, \
Uform_, slowIV_, fastIV_, levelcountdummy_, option_] :=
    ...
    chosen2 = 0, dimlesscoefparts, bracketeddummy},
        ...
        If[Length[inthepower] > 1,
            ...
            If[power <= 0,
                ...
                dimlesscoef = getterminfo[newinthepower, isdependenton, allVariables, allRanks, \
                  closurevar, graddenoters, divdenoters, avgdenoters, derivativedenoters, dotdenoters, tensorproductdenoters, doubledotdenoters, pietrzykflipdenoters, \
                  divform, gradform, normalvecform, Uform, slowIV, fastIV, levelcountdummy, \
                  option];
                ,
...
(*Checked*)
subsubcaseDerivative[term_, isdependenton_, allVariables_, allRanks_, closurevar_, \
...
slowIV_, fastIV_, levelcountdummy_, option_] :=
    ...
    argumentpartsbracketed},
        ...
        argumentparts = getterminfo[argument, {subscript}, allVariables, allRanks, \
          closurevar, graddenoters, divdenoters, avgdenoters, derivativedenoters, dotdenoters, \
        ...
        For[iii = 1, iii <= Length[argumentparts], iii++,
            argumentpartsbracketed = subsubcaseDerivativeSimp[{argumentparts[[iii]]}, \
              subscript, isdependenton, allVariables, allRanks, closurevar, \
              graddenoters, divdenoters, avgdenoters, derivativedenoters, dotdenoters, tensorproductdenoters, \
              doubledotdenoters, pietrzykflipdenoters, divform, gradform, normalvecform, Uform, slowIV, fastIV, \
...
(*Checked*)
subsubcaseDerivativeSimp[argumentparts_, subscript_, isdependenton_, allVariables_, allRanks_, \
closurevar_, graddenoters_, divdenoters_, avgdenoters_, derivativedenoters_, \
        ...
        If[chosen == 0,
            If[Length[scalarmults[[1, 1]]] > 0,
                scalarmults2 = getterminfo[listProduct[scalarmults[[1, 1]]], \
                  isdependenton, allVariables, allRanks, closurevar, graddenoters, \
                  divdenoters, avgdenoters, derivativedenoters, dotdenoters, tensorproductdenoters, \
                  doubledotdenoters, pietrzykflipdenoters, divform, gradform, normalvecform, Uform, slowIV, fastIV, \
                  levelcountdummy, option];
                ,
...
(*Checked*)
subsubcaseDerivativeSimpSimp[term_, subscript_, isdependenton_, allVariables_, allRanks_, \
closurevar_, graddenoters_, divdenoters_, avgdenoters_, derivativedenoters_, \
dotdenoters_, tensorproductdenoters_, doubledotdenoters_, pietrzykflipdenoters_, divform_, gradform_, \
normalvecform_, Uform_, slowIV_, fastIV_, levelcountdummy_, option_] :=
    Block[{i, chosen, iterms, newargumentparts2dummy, newargumentparts2 = {}},
        ...
        For[iterms = 1, iterms <= Length[term], iterms++,
            ...
            If[Intersection[globalSimplificationMode, globalSimplificationDerivatives] != {},
                {newargumentparts2dummy, chosen} = subsubcaseDerivativeSimpSimpSimp[{term[[iterms]]}, subscript, isdependenton, allVariables, allRanks, \
                  closurevar, graddenoters, divdenoters, avgdenoters, derivativedenoters, dotdenoters, \
                  tensorproductdenoters, doubledotdenoters, pietrzykflipdenoters, divform, gradform, normalvecform, Uform, \
                  slowIV, fastIV, levelcountdummy, option];
            ];
...
(*Checked*)
subsubcaseDerivativeSimpSimpSimp[term_, subscript_, isdependenton_, allVariables_, allRanks_, \
closurevar_, graddenoters_, divdenoters_, avgdenoters_, derivativedenoters_, \
dotdenoters_, tensorproductdenoters_, doubledotdenoters_, pietrzykflipdenoters_, divform_, gradform_, \
normalvecform_, Uform_, slowIV_, fastIV_, levelcountdummy_, option_] :=
        ...
        If[Length[term[[1, 1]]] == 1 && chosen == 0,
            If[Head[term[[1, 1, 1]]] == Head[dotdenoters[[1]]],
                ...
                termdotunfold = UnfoldMergedTerms[term, dotdenoters, \
                  {subscript}, allVariables, allRanks, closurevar, graddenoters, \
                  divdenoters, avgdenoters, derivativedenoters, dotdenoters, tensorproductdenoters, \
                  doubledotdenoters, pietrzykflipdenoters, divform, gradform, normalvecform, Uform, slowIV, \
                    ...
                    For[i = 1, i <= Length[termdotunfold2[[1, 1, 1]]], i++,
                        If[termdotunfold[[1, 3, 1, i]] == 1,
                            ...
                            term2 = getterminfo[termdotunfold[[1, 1, 1]], \
                              isdependenton, allVariables, allRanks, closurevar, \
...
subsubcaseDerivativeSimpSimpOLD[term_, subscript_, isdependenton_, allVariables_, allRanks_, \
closurevar_, graddenoters_, divdenoters_, avgdenoters_, derivativedenoters_, \
dotdenoters_, tensorproductdenoters_, doubledotdenoters_, pietrzykflipdenoters_, divform_, gradform_, \
normalvecform_, Uform_, slowIV_, fastIV_, levelcountdummy_, option_] :=
...
(*Checked*)
subsubcaseTimes[term_, isdependenton_, allVariables_, allRanks_, closurevar_, \
...
levelcountdummy_, option_] :=
    ...
    camebackSum = {}, newterm},
        ...
        If[Head[expandedterm] == Plus,
            ...
            dimlesscoef = getterminfo[expandedterm, isdependenton, allVariables, allRanks, \
              closurevar, graddenoters, divdenoters, avgdenoters, derivativedenoters, dotdenoters, \
              tensorproductdenoters, doubledotdenoters, pietrzykflipdenoters, divform, gradform, normalvecform, \
              Uform, slowIV, fastIV, levelcountdummy, option];
        ...
        For[i = 1, i <= Length[term], i++,
            ...
            dummy = getterminfo[term[[i]], isdependenton, allVariables, allRanks, \
              closurevar, graddenoters, divdenoters, avgdenoters, derivativedenoters, dotdenoters, \
              tensorproductdenoters, doubledotdenoters, pietrzykflipdenoters, divform, gradform, normalvecform, \
              Uform, slowIV, fastIV, levelcountdummy, option];
        ...
        If[camebackSum == 1,
            newterm = Expand[MakeSingleTerm[dimlesscoef, {}, dotdenoters, \
              tensorproductdenoters, doubledotdenoters]];
            dimlesscoef = getterminfo[newterm[[1, 1, 1]], isdependenton, allVariables, allRanks, \
              closurevar, graddenoters, divdenoters, avgdenoters, derivativedenoters, dotdenoters, \
              tensorproductdenoters, doubledotdenoters, pietrzykflipdenoters, divform, gradform, normalvecform, \
              Uform, slowIV, fastIV, levelcountdummy, option];
        ];
...
(*Checked*)
subsubcaseDot[term_, isdependenton_, allVariables_, allRanks_, closurevar_, \
graddenoters_, divdenoters_, avgdenoters_, derivativedenoters_, dotdenoters_, tensorproductdenoters_, \
doubledotdenoters_, pietrzykflipdenoters_, divform_, gradform_, normalvecform_, Uform_, slowIV_, fastIV_, \
levelcountdummy_, option_] :=
    ...
    dropindices = {}},
        ...
        For[i = 1, i <= Length[term], i++,
            ...
            If[Head[expandedterm] == Plus,
                ...
                dimlesscoef = getterminfo[dotexpandedterm, isdependenton, allVariables, allRanks, \
                  closurevar, graddenoters, divdenoters, avgdenoters, derivativedenoters, dotdenoters, \
                  tensorproductdenoters, doubledotdenoters, pietrzykflipdenoters, divform, gradform, normalvecform, \
                  Uform, slowIV, fastIV, levelcountdummy, option];
        ...
        If[camebackSum == 1,
            dimlesscoef = MakeSingleTerm[dimlesscoef, dotdenoters, dotdenoters, \
              tensorproductdenoters, doubledotdenoters];
            dimlesscoef = getterminfo[dimlesscoef[[1, 1, 1]], isdependenton, allVariables, allRanks, \
              closurevar, graddenoters, divdenoters, avgdenoters, derivativedenoters, \
              dotdenoters, tensorproductdenoters, doubledotdenoters, pietrzykflipdenoters, divform, gradform, \
              normalvecform, Uform, slowIV, fastIV, levelcountdummy, option];
            ,
            ...
            dimlesscoef = subsubcaseDotSimpSimp[dimlesscoef, isdependenton, allVariables, allRanks, \
              closurevar, graddenoters, divdenoters, avgdenoters, derivativedenoters, dotdenoters, \
              tensorproductdenoters, doubledotdenoters, pietrzykflipdenoters, divform, gradform, normalvecform, \
              Uform, slowIV, fastIV, levelcountdummy, option];
...
(*Checked*)
subsubcaseDotSimpSimp[term_, isdependenton_, allVariables_, allRanks_, closurevar_, \
graddenoters_, divdenoters_, avgdenoters_, derivativedenoters_, dotdenoters_, tensorproductdenoters_, \
doubledotdenoters_, pietrzykflipdenoters_, divform_, gradform_, normalvecform_, Uform_, slowIV_, fastIV_, \
levelcountdummy_, option_] :=
    Block[{chosen, iterms, newargumentparts2dummy, newargumentparts2 = {}},
        ...
        For[iterms = 1, iterms <= Length[term], iterms++,
            ...
            If[Intersection[globalSimplificationMode, globalSimplificationDots] != {},
                {newargumentparts2dummy, chosen} = subsubcaseDotSimpSimpSimp[{term[[iterms]]}, isdependenton, allVariables, allRanks, \
                  closurevar, graddenoters, divdenoters, avgdenoters, derivativedenoters, dotdenoters, \
                  tensorproductdenoters, doubledotdenoters, pietrzykflipdenoters, divform, gradform, normalvecform, Uform, \
                  slowIV, fastIV, levelcountdummy, option];
            ];
...
(*Checked*)
subsubcaseDotSimpSimpSimp[term_, isdependenton_, allVariables_, allRanks_, closurevar_, \
graddenoters_, divdenoters_, avgdenoters_, derivativedenoters_, dotdenoters_, tensorproductdenoters_, \
doubledotdenoters_, pietrzykflipdenoters_, divform_, gradform_, normalvecform_, Uform_, slowIV_, fastIV_, \
levelcountdummy_, option_] :=
...
subsubcaseDotSimpSimpOLD[term_, isdependenton_, allVariables_, allRanks_, closurevar_, \
graddenoters_, divdenoters_, avgdenoters_, derivativedenoters_, dotdenoters_, tensorproductdenoters_, \
doubledotdenoters_, pietrzykflipdenoters_, divform_, gradform_, normalvecform_, Uform_, slowIV_, fastIV_, \
levelcountdummy_, option_] :=
    Block[{i, chosen = 0, iterms, newargumentparts2 = {}, flag1 = 0, flag2 = 0, scalar, \
...
(*Checked*)
subsubcaseTensorProduct[term_, isdependenton_, allVariables_, allRanks_, closurevar_, \
graddenoters_, divdenoters_, avgdenoters_, derivativedenoters_, dotdenoters_, tensorproductdenoters_, \
doubledotdenoters_, pietrzykflipdenoters_, divform_, gradform_, normalvecform_, Uform_, slowIV_, fastIV_, \
levelcountdummy_, option_] :=
    ...
    chosen3 = 0, dropindices = {}},
        ...
        For[i = 1, i <= Length[term], i++,
            ...
            If[Head[expandedterm] == Plus,
                ...
                dimlesscoef = getterminfo[tensorexpandedterm, isdependenton, allVariables, allRanks, \
                  closurevar, graddenoters, divdenoters, avgdenoters, derivativedenoters, \
                  dotdenoters, tensorproductdenoters, doubledotdenoters, pietrzykflipdenoters, divform, gradform, \
                  normalvecform, Uform, slowIV, fastIV, levelcountdummy, option];
        ...
        If[camebackSum == 1,
            ...
            dimlesscoef = subsubcaseTensorProductSimpSimp[dimlesscoef, isdependenton, allVariables, allRanks, \
              closurevar, graddenoters, divdenoters, avgdenoters, derivativedenoters, dotdenoters, \
              tensorproductdenoters, doubledotdenoters, pietrzykflipdenoters, divform, gradform, normalvecform, \
              Uform, slowIV, fastIV, levelcountdummy, option];
...
(*Checked*)
subsubcaseTensorProductSimpSimp[term_, isdependenton_, allVariables_, allRanks_, closurevar_, \
graddenoters_, divdenoters_, avgdenoters_, derivativedenoters_, dotdenoters_, tensorproductdenoters_, \
doubledotdenoters_, pietrzykflipdenoters_, divform_, gradform_, normalvecform_, Uform_, slowIV_, fastIV_, \
levelcountdummy_, option_] :=
    Block[{chosen = 0, iterms, newargumentparts2dummy, newargumentparts2 = {}},
        ...
        For[iterms = 1, iterms <= Length[term], iterms++,
            ...
            If[Intersection[globalSimplificationMode, globalSimplificationTensorProducts] != {},
                {newargumentparts2dummy, chosen} = subsubcaseTensorProductSimpSimpSimp[{term[[iterms]]}, isdependenton, allVariables, allRanks, \
                  closurevar, graddenoters, divdenoters, avgdenoters, derivativedenoters, dotdenoters, \
                  tensorproductdenoters, doubledotdenoters, pietrzykflipdenoters, divform, gradform, normalvecform, Uform, \
                  slowIV, fastIV, levelcountdummy, option];
            ];
...
(*Checked*)
subsubcaseTensorProductSimpSimpSimp[term_, isdependenton_, allVariables_, allRanks_, closurevar_, \
graddenoters_, divdenoters_, avgdenoters_, derivativedenoters_, dotdenoters_, tensorproductdenoters_, \
doubledotdenoters_, pietrzykflipdenoters_, divform_, gradform_, normalvecform_, Uform_, slowIV_, fastIV_, \
levelcountdummy_, option_] :=
...
subsubcaseTensorProductSimpSimpOLD[term_, isdependenton_, allVariables_, allRanks_, closurevar_, \
graddenoters_, divdenoters_, avgdenoters_, derivativedenoters_, dotdenoters_, tensorproductdenoters_, \
doubledotdenoters_, pietrzykflipdenoters_, divform_, gradform_, normalvecform_, Uform_, slowIV_, fastIV_, \
levelcountdummy_, option_] :=
...
(*Checked*)
subsubcaseDoubleDot[term_, isdependenton_, allVariables_, allRanks_, closurevar_, \
graddenoters_, divdenoters_, avgdenoters_, derivativedenoters_, dotdenoters_, tensorproductdenoters_, \
doubledotdenoters_, pietrzykflipdenoters_, divform_, gradform_, normalvecform_, Uform_, slowIV_, fastIV_, \
levelcountdummy_, option_] :=
    Block[{dimlesscoef = {{{{}}, {{}}, {{}}}}, i, ii, j, dummy, iii, irank, \
    ...
    chosen3 = 0, dropindices},
        ...
        For[i = 1, i <= Length[term], i++,
            ...
            If[Head[expandedterm] == Plus,
                ...
                dimlesscoef = getterminfo[doubledotexpandedterm, isdependenton, allVariables, allRanks, \
                  closurevar, graddenoters, divdenoters, avgdenoters, derivativedenoters, \
                  dotdenoters, tensorproductdenoters, doubledotdenoters, pietrzykflipdenoters, divform, gradform, \
                  normalvecform, Uform, slowIV, fastIV, levelcountdummy, option];
        ...
        If[camebackSum == 1,
            ...
            dimlesscoef = subsubcaseDoubleDotSimpSimp[dimlesscoef, isdependenton, allVariables, allRanks, \
              closurevar, graddenoters, divdenoters, avgdenoters, derivativedenoters, dotdenoters, \
              tensorproductdenoters, doubledotdenoters, pietrzykflipdenoters, divform, gradform, normalvecform, \
              Uform, slowIV, fastIV, levelcountdummy, option];
...
(*Checked*)
subsubcaseDoubleDotSimpSimp[term_, isdependenton_, allVariables_, allRanks_, closurevar_, \
graddenoters_, divdenoters_, avgdenoters_, derivativedenoters_, dotdenoters_, tensorproductdenoters_, \
doubledotdenoters_, pietrzykflipdenoters_, divform_, gradform_, normalvecform_, Uform_, slowIV_, fastIV_, \
levelcountdummy_, option_] :=
    Block[{chosen = 0, iterms, newargumentparts2dummy, newargumentparts2 = {}},
        ...
        For[iterms = 1, iterms <= Length[term], iterms++,
            ...
            If[Intersection[globalSimplificationMode, globalSimplificationDoubleDots] != {},
                {newargumentparts2dummy, chosen} = subsubcaseDoubleDotSimpSimpSimp[{term[[iterms]]}, isdependenton, allVariables, allRanks, \
                  closurevar, graddenoters, divdenoters, avgdenoters, derivativedenoters, dotdenoters, \
                  tensorproductdenoters, doubledotdenoters, pietrzykflipdenoters, divform, gradform, normalvecform, Uform, \
                  slowIV, fastIV, levelcountdummy, option];
            ];
...
(*Checked*)
subsubcaseDoubleDotSimpSimpSimp[term_, isdependenton_, allVariables_, allRanks_, closurevar_, \
graddenoters_, divdenoters_, avgdenoters_, derivativedenoters_, dotdenoters_, tensorproductdenoters_, \
doubledotdenoters_, pietrzykflipdenoters_, divform_, gradform_, normalvecform_, Uform_, slowIV_, fastIV_, \
levelcountdummy_, option_] :=
    Block[{chosen = 0, newargumentparts2 = {}},
...
subsubcaseDoubleDotSimpSimpOLD[term_, isdependenton_, allVariables_, allRanks_, closurevar_, \
graddenoters_, divdenoters_, avgdenoters_, derivativedenoters_, dotdenoters_, tensorproductdenoters_, \
doubledotdenoters_, pietrzykflipdenoters_, divform_, gradform_, normalvecform_, Uform_, slowIV_, fastIV_, \
levelcountdummy_, option_] :=
    Block[{chosen = 0, iterms, newargumentparts2 = {}, dummy},
...
(*Checked*)
subsubcasePlus[term_, isdependenton_, allVariables_, allRanks_, closurevar_, \
graddenoters_, divdenoters_, avgdenoters_, derivativedenoters_, dotdenoters_, tensorproductdenoters_, \
doubledotdenoters_, pietrzykflipdenoters_, divform_, gradform_, normalvecform_, Uform_, slowIV_, fastIV_, \
levelcountdummy_, option_] :=
    ...
    expandedterm = Expand[term]},
        ...
        If[Head[expandedterm] == Plus,
            For[i = 1, i <= Length[expandedterm], i++,
                termparts = getterminfo[expandedterm[[i]], isdependenton, allVariables, allRanks, \
                  closurevar, graddenoters, divdenoters, avgdenoters, derivativedenoters, dotdenoters, \
                  tensorproductdenoters, doubledotdenoters, pietrzykflipdenoters, divform, gradform, normalvecform, \
                  Uform, slowIV, fastIV, levelcountdummy, option];
...
(*Checked*)
subsubcaseGradient[term_, isdependenton_, allVariables_, allRanks_, closurevar_, \
graddenoters_, divdenoters_, avgdenoters_, derivativedenoters_, dotdenoters_, tensorproductdenoters_, \
doubledotdenoters_, pietrzykflipdenoters_, divform_, gradform_, normalvecform_, Uform_, slowIV_, fastIV_, \
levelcountdummy_, option_] :=
    Block[{dimlesscoef = {}, subscript = term[[2]], argument = term[[1]], \
...
(*Checked*)
subsubcaseGradientSimp[argumentparts_, subscript_, isdependenton_, allVariables_, allRanks_, \
closurevar_, graddenoters_, divdenoters_, avgdenoters_, derivativedenoters_, dotdenoters_, \
tensorproductdenoters_, doubledotdenoters_, pietrzykflipdenoters_, divform_, gradform_, normalvecform_, Uform_, \
slowIV_, fastIV_, levelcountdummy_, option_] :=
    Block[{dimlesscoef = {{{}, {}, {}}}, scalarmults = {{{}, {}, {}}}, \
    newargumentparts = {{{}, {}, {}}}, i, flag1 = 0, flag2 = 0, chosen = 0, \
...
(*Checked*)
subsubcaseGradientSimpSimp[term_, subscript_, isdependenton_, allVariables_, allRanks_, \
closurevar_, graddenoters_, divdenoters_, avgdenoters_, derivativedenoters_, dotdenoters_, \
tensorproductdenoters_, doubledotdenoters_, pietrzykflipdenoters_, divform_, gradform_, normalvecform_, Uform_, \
slowIV_, fastIV_, levelcountdummy_, option_] :=
    Block[{i, chosen = 0, iterms, newargumentparts2dummy, newargumentparts2 = {}},
        ...
        For[iterms = 1, iterms <= Length[term], iterms++,
            ...
            If[Intersection[globalSimplificationMode, globalSimplificationGradients] != {},
                {newargumentparts2dummy, chosen} = subsubcaseGradientSimpSimpSimp[{term[[iterms]]}, subscript, isdependenton, allVariables, allRanks, \
                  closurevar, graddenoters, divdenoters, avgdenoters, derivativedenoters, dotdenoters, \
                  tensorproductdenoters, doubledotdenoters, pietrzykflipdenoters, divform, gradform, normalvecform, Uform, \
                  slowIV, fastIV, levelcountdummy, option];
            ];
...
(*Checked*)
subsubcaseGradientSimpSimpSimp[term_, subscript_, isdependenton_, allVariables_, allRanks_, \
closurevar_, graddenoters_, divdenoters_, avgdenoters_, derivativedenoters_, dotdenoters_, \
tensorproductdenoters_, doubledotdenoters_, pietrzykflipdenoters_, divform_, gradform_, normalvecform_, Uform_, \
slowIV_, fastIV_, levelcountdummy_, option_] :=
    Block[{i, chosen = 0, newargumentparts2 = {}, flag1 = 0, flag2 = 0, scalar, \
...
subsubcaseGradientSimpSimpOLD[term_, subscript_, isdependenton_, allVariables_, allRanks_, \
closurevar_, graddenoters_, divdenoters_, avgdenoters_, derivativedenoters_, dotdenoters_, \
tensorproductdenoters_, doubledotdenoters_, pietrzykflipdenoters_, divform_, gradform_, normalvecform_, Uform_, \
slowIV_, fastIV_, levelcountdummy_, option_] :=
    Block[{i, chosen = 0, iterms, newargumentparts2 = {}, flag1 = 0, flag2 = 0, scalar, \
...
(*Checked*)
subsubcaseDivergence[term_, isdependenton_, allVariables_, allRanks_, closurevar_, \
graddenoters_, divdenoters_, avgdenoters_, derivativedenoters_, dotdenoters_, tensorproductdenoters_, \
doubledotdenoters_, pietrzykflipdenoters_, divform_, gradform_, normalvecform_, Uform_, slowIV_, fastIV_, \
levelcountdummy_, option_] :=
    Block[{dimlesscoef = {}, subscript = term[[2]], argument = term[[1]], \
...
(*Checked*)
subsubcaseDivergenceSimp[argumentparts_, subscript_, isdependenton_, allVariables_, allRanks_, \
closurevar_, graddenoters_, divdenoters_, avgdenoters_, derivativedenoters_, dotdenoters_, \
tensorproductdenoters_, doubledotdenoters_, pietrzykflipdenoters_, divform_, gradform_, normalvecform_, Uform_, \
slowIV_, fastIV_, levelcountdummy_, option_] :=
    Block[{dimlesscoef = {{{}, {}, {}}}, scalarmults = {{{}, {}, {}}}, \
...
(*Checked*)
subsubcaseDivergenceSimpSimp[term_, subscript_, isdependenton_, allVariables_, allRanks_, \
closurevar_, graddenoters_, divdenoters_, avgdenoters_, derivativedenoters_, dotdenoters_, \
tensorproductdenoters_, doubledotdenoters_, pietrzykflipdenoters_, divform_, gradform_, normalvecform_, Uform_, \
slowIV_, fastIV_, levelcountdummy_, option_] :=
    Block[{i, chosen, iterms, newargumentparts2dummy, newargumentparts2 = {}},
        ...
        For[iterms = 1, iterms <= Length[term], iterms++,
            ...
            If[Intersection[globalSimplificationMode, globalSimplificationDivergences] != {},
                {newargumentparts2dummy, chosen} = subsubcaseDivergenceSimpSimpSimp[{term[[iterms]]}, subscript, isdependenton, allVariables, allRanks, \
                  closurevar, graddenoters, divdenoters, avgdenoters, derivativedenoters, dotdenoters, \
                  tensorproductdenoters, doubledotdenoters, pietrzykflipdenoters, divform, gradform, normalvecform, Uform, \
                  slowIV, fastIV, levelcountdummy, option];
            ];
...
(*Checked*)
subsubcaseDivergenceSimpSimpSimp[term_, subscript_, isdependenton_, allVariables_, allRanks_, \
closurevar_, graddenoters_, divdenoters_, avgdenoters_, derivativedenoters_, dotdenoters_, \
tensorproductdenoters_, doubledotdenoters_, pietrzykflipdenoters_, divform_, gradform_, normalvecform_, Uform_, \
slowIV_, fastIV_, levelcountdummy_, option_] :=
    Block[{i, chosen = 0, newargumentparts2 = {}, flag1 = 0, flag2 = 0, scalar, \
        ...
        If[Length[term[[1, 1]]] >= 2 && chosen == 0,
            If[Total[term[[1, 2]]] == 1,
                ...
                vectornabladependencytestinfo = getterminfo[vector[[1, 1, 1]], subscript, \
                  allVariables, allRanks, closurevar, graddenoters, divdenoters, \
                ...
                If[Head[vector[[1, 1, 1]]] == Head[dotdenoters[[1]]],
                    ...
                    vectordotunfold = UnfoldMergedTerms[vectornabladependencytestinfo, \
                      dotdenoters, subscript, allVariables, allRanks, closurevar, \
                      graddenoters, divdenoters, avgdenoters, derivativedenoters, \
                      dotdenoters, tensorproductdenoters, doubledotdenoters, \
...
subsubcaseDivergenceSimpSimpOLD[term_, subscript_, isdependenton_, allVariables_, allRanks_, \
closurevar_, graddenoters_, divdenoters_, avgdenoters_, derivativedenoters_, dotdenoters_, \
tensorproductdenoters_, doubledotdenoters_, pietrzykflipdenoters_, divform_, gradform_, normalvecform_, Uform_, \
slowIV_, fastIV_, levelcountdummy_, option_] :=
    Block[{i, chosen = 0, iterms, newargumentparts2 = {}, flag1 = 0, flag2 = 0, scalar, \
...
(*Checked*)
subsubcaseAverage[term_, isdependenton_, allVariables_, allRanks_, closurevar_, \
graddenoters_, divdenoters_, avgdenoters_, derivativedenoters_, dotdenoters_, tensorproductdenoters_, \
doubledotdenoters_, pietrzykflipdenoters_, divform_, gradform_, normalvecform_, Uform_, slowIV_, fastIV_, \
levelcountdummy_, option_] :=
        ...
        For[iavg = 1, iavg <= Length[avgdenoterssymbols], iavg++,
            If[Intersection[{subscript}, avgdenoterssymbols[[iavg]]] != {} || \
              Intersection[{subscript}, Flatten[avgdenoterssplitdomainsymbols[[iavg]]]] != {},
                ...
                argumentparts = getterminfo[argument, avgdenoters[[2, iavg, 2]], allVariables, allRanks, \
                  closurevar, graddenoters, divdenoters, avgdenoters, derivativedenoters, \
                  dotdenoters, tensorproductdenoters, doubledotdenoters, pietrzykflipdenoters, divform, gradform, \
                  normalvecform, Uform, slowIV, fastIV, levelcountdummy, option];
                ...
                For[iii = 1, iii <= Length[argumentparts], iii++,
                    argumentpartsbracketed = subsubcaseAverageSimp[{argumentparts[[iii]]}, \
                      subscript, avgdenoters[[2, iavg, 2]], isdependenton, allVariables, allRanks, \
                      closurevar, graddenoters, divdenoters, avgdenoters, derivativedenoters, \
...
(*Checked*)
subsubcaseAverageSimp[argumentparts_, subscript_, IVofsubscript_, isdependenton_, allVariables_, allRanks_, \
closurevar_, graddenoters_, divdenoters_, avgdenoters_, derivativedenoters_, dotdenoters_, \
tensorproductdenoters_, doubledotdenoters_, pietrzykflipdenoters_, divform_, gradform_, normalvecform_, Uform_, \
slowIV_, fastIV_, levelcountdummy_, option_] :=
    Block[{dimlesscoef = {{{}, {}, {}}}, scalarmults = {{{}, {}, {}}}, \
        ...
        If[Intersection[IVofsubscript, isdependenton] != {},
            ...
            If[Length[newargumentparts[[1, 1]]] > 0,
                newargumentparts = subsubcaseAverageSimpSimp[newargumentparts, subscript, \
                  IVofsubscript, isdependenton, allVariables, allRanks, closurevar, \
                  graddenoters, divdenoters, avgdenoters, derivativedenoters, dotdenoters, tensorproductdenoters, \
                  doubledotdenoters, pietrzykflipdenoters, divform, gradform, normalvecform, Uform, slowIV, fastIV, \
                  levelcountdummy, option];
            ];
...
subsubcaseAverageSimpSimp[term_, subscript_, IVofsubscript_, isdependenton_, allVariables_, allRanks_, \
closurevar_, graddenoters_, divdenoters_, avgdenoters_, derivativedenoters_, dotdenoters_, \
tensorproductdenoters_, doubledotdenoters_, pietrzykflipdenoters_, divform_, gradform_, normalvecform_, Uform_, \
slowIV_, fastIV_, levelcountdummy_, option_] :=
    Block[{i, chosen = 0, iterms, newargumentparts2 = {}, flag1 = 0, flag2 = 0, scalar, \
    ...
    termnotdot, termdot, newtermnotdot, flagnotdot},
        ...
        For[iterms = 1, iterms <= Length[term], iterms++,
            ...
            If[Length[term[[iterms, 1]]] == 1 && chosen == 0,
                newterminfo = getterminfo[term[[iterms, 1, 1]], IVofsubscript, allVariables, allRanks, \
                  closurevar, graddenoters, divdenoters, avgdenoters, \
            ...
            If[Length[term[[iterms, 1]]] == 1 && chosen == 0,
                If[Head[term[[iterms, 1, 1]]] == Head[dotdenoters[[1]]],
                    ...
                    termdotunfold = UnfoldMergedTerms[{term[[iterms]]}, dotdenoters, \
                      IVofsubscript, allVariables, allRanks, closurevar, graddenoters, \
                      divdenoters, avgdenoters, derivativedenoters, dotdenoters, tensorproductdenoters, \
                      doubledotdenoters, pietrzykflipdenoters, divform, gradform, normalvecform, Uform, slowIV, \
                      fastIV, levelcountdummy, option];
                                ...
                                If[Intersection[termdotunfold[[1, 1, 1, \
                                  dependentIndices[[1]], 2]], IVofsubscript] == {},
                                    ...
                                    newterminfo = getterminfo[termdotunfold, \
                                      isdependenton, allVariables, allRanks, \
                                      closurevar, graddenoters, divdenoters, avgdenoters, \
...
UnfoldMergedTerms[term_, bracketform_, isdependenton_, allVariables_, allRanks_, closurevar_, \
graddenoters_, divdenoters_, avgdenoters_, derivativedenoters_, dotdenoters_, tensorproductdenoters_, \
doubledotdenoters_, pietrzykflipdenoters_, divform_, gradform_, normalvecform_, Uform_, slowIV_, fastIV_, \
levelcountdummy_, option_] :=
