...
(****** OperatorExpander.wl -- Expand the spatial and temporal derivatives in a term (fast 
and slow variables).
*************)

(* 

OperatorExpander[term_, Dependent variables, independent variables, new independent variables, \
    dimensionless numbers] 

Given a term, expand the spacial and time derivatives according to the present fast and slow
variables. These are declared by inputing different dimensionless numbers.

Example input:

[(a^(1,0,0))[x,y,t], {a,b,c,u,v}, {x,y,t}, {\[Xi],\[Eta],{\[Tau]a,\[Tau]b}}, {Pe1,Pe2,{Da1,Da2}}, \
...
BeginPackage["Disruptioneering`OperatorExpander`"];

OperatorExpander::usage = 
"OperatorExpander[term, ]  Given a term, expand the spacial and time derivatives according to the present fast and slow
variables. These are declared by inputing different dimensionless numbers.";
...
OperatorExpander[term_, originalIV_, newIV_, newIVDimlessNumber_, scalars_, vectors_, tensors_, \
...
divform_, gradform_, normalvecform_, Uform_, slowIV_, fastIV_, option_] := 
    procedure[term, originalIV, newIV, newIVDimlessNumber, scalars, vectors, tensors, \
...
procedure[term_, originalIV_, newIV_, newIVDimlessNumber_, scalars_, vectors_, tensors_, closurevar_, graddenoters_, \
...
divform_, gradform_, normalvecform_, Uform_, slowIV_, fastIV_, option_] :=
    Block[{functionName = "OperatorExpander", solution},
        
        solution = main[Expand[term], originalIV, newIV, newIVDimlessNumber, scalars, vectors, tensors, closurevar, \
...
main[term_, originalIV_, newIV_, newIVDimlessNumber_, scalars_, vectors_, tensors_, closurevar_, graddenoters_, \
divdenoters_, avgdenoters_, derivativedenoters_, dotdenoters_, tensorproductdenoters_, doubledotdenoters_, pietrzykflipdenoters_, \
divform_, gradform_, normalvecform_, Uform_, slowIV_, fastIV_, option_] :=
    Block[{solution},
        
        If[Head[term] == List,
            solution = caseListmain[term, originalIV, newIV, newIVDimlessNumber, scalars, vectors, tensors, closurevar, \
              ...
              option];
            ,
            solution = caseNonListmain[term, originalIV, newIV, newIVDimlessNumber, scalars, vectors, tensors, closurevar, \
              graddenoters, divdenoters, avgdenoters, derivativedenoters, dotdenoters, tensorproductdenoters, \
              doubledotdenoters, pietrzykflipdenoters, divform, gradform, normalvecform, Uform, slowIV, fastIV, \
              option];
            ,
...
caseListmain[term_, originalIV_, newIV_, newIVDimlessNumber_, scalars_, vectors_, tensors_, closurevar_, graddenoters_, \
divdenoters_, avgdenoters_, derivativedenoters_, dotdenoters_, tensorproductdenoters_, doubledotdenoters_, pietrzykflipdenoters_, \
divform_, gradform_, normalvecform_, Uform_, slowIV_, fastIV_, option_] :=
    Block[{i, solution = ConstantArray[0, Length[term]]},
        
        For[i = 1, i <= Length[term], i++,
            solution[[i]] = main[term[[i]], originalIV, newIV, newIVDimlessNumber, scalars, vectors, tensors, closurevar, \
              graddenoters, divdenoters, avgdenoters, derivativedenoters, dotdenoters, tensorproductdenoters, \
              doubledotdenoters, pietrzykflipdenoters, divform, gradform, normalvecform, Uform, slowIV, fastIV, \
              option];
        ];
...
caseNonListmain[term_, originalIV_, newIV_, newIVDimlessNumber_, scalars_, vectors_, tensors_, closurevar_, graddenoters_, \
divdenoters_, avgdenoters_, derivativedenoters_, dotdenoters_, tensorproductdenoters_, doubledotdenoters_, pietrzykflipdenoters_, \
divform_, gradform_, normalvecform_, Uform_, slowIV_, fastIV_, option_] :=
    Block[{i, solution, solutionvec},
        ...
        If[Head[term] == Plus,
            ...
            For[i = 1, i <= Length[term], i++,
                solutionvec[[i]] = casePlusSubstituter[term[[i]], originalIV, newIV, newIVDimlessNumber, scalars, \
            ...
            ,
            solution = casePlusSubstituter[term, originalIV, newIV, newIVDimlessNumber, scalars, vectors, tensors, \
...
casePlusSubstituter[term_, originalIV_, newIV_, newIVDimlessNumber_, scalars_, vectors_, tensors_, closurevar_, \
...
gradform_, normalvecform_, Uform_, slowIV_, fastIV_, option_] :=
    Block[{solution, levelcountdummy = 0, i},
        ...
        solution = decider[term, originalIV, newIV, newIVDimlessNumber, scalars, vectors, tensors, closurevar, \
...
decider[term_, originalIV_, newIV_, newIVDimlessNumber_, scalars_, vectors_, tensors_, closurevar_, graddenoters_, \
    ...
    dependencies, i, flagsubscript = 0, printouttoggle = 0},
        ...
        If[levelcount == 1000,
            ...
            If[Head[term] == List && chosen == 0,
                ...
                chosen = 1;
                dimlesscoef = caseList[term, originalIV, newIV, newIVDimlessNumber, scalars, vectors, tensors, \
            ...
            If[Head[term] == Rational && chosen == 0,
                ...
                chosen = 1;
                dimlesscoef = caseRational[term, originalIV, newIV, newIVDimlessNumber, scalars, vectors, \
            ...
            If[Head[term] == Integer && chosen == 0,
                ...
                chosen = 1;
                dimlesscoef = caseInteger[term, originalIV, newIV, newIVDimlessNumber, scalars, vectors, \
                  tensors,closurevar, graddenoters, divdenoters, avgdenoters, derivativedenoters, dotdenoters, tensorproductdenoters, doubledotdenoters, pietrzykflipdenoters, \
                  divform, gradform, normalvecform, Uform, slowIV, fastIV, levelcountdummy, \
                  option];
            ];
            If[Head[term] == Symbol && chosen == 0,
                ...
                chosen = 1;
                dimlesscoef = caseSymbol[term, originalIV, newIV, newIVDimlessNumber, scalars, vectors, \
                  tensors, closurevar, graddenoters, divdenoters, avgdenoters, derivativedenoters, dotdenoters, tensorproductdenoters, doubledotdenoters, pietrzykflipdenoters, \
                  divform, gradform, normalvecform, Uform, slowIV, fastIV, levelcountdummy, \
                  option];
            ];
            If[Head[term] == Head[pietrzykflipdenoters[[1]]] && chosen == 0,
                If[term[[2]] == pietrzykflipdenoters[[2]],
                    ...
                    chosen = 1;
                    dimlesscoef = casePietrzykFlip[term, originalIV, newIV, newIVDimlessNumber, scalars, vectors, tensors, \
                      closurevar, graddenoters, divdenoters, avgdenoters, derivativedenoters, dotdenoters, tensorproductdenoters, doubledotdenoters, pietrzykflipdenoters, divform, \
                      gradform, normalvecform, Uform, slowIV, fastIV, levelcountdummy, option];
                ];
            ];
            If[Head[term] == Power && chosen == 0,
                ...
                chosen = 1;
                dimlesscoef = casePower[term, originalIV, newIV, newIVDimlessNumber, scalars, vectors, tensors, \
                  closurevar, graddenoters, divdenoters, avgdenoters, derivativedenoters, dotdenoters, tensorproductdenoters, doubledotdenoters, pietrzykflipdenoters, divform, \
                  gradform, normalvecform, Uform, slowIV, fastIV, levelcountdummy, option];
            ];
            If[Head[term] == Head[derivativedenoters[[1]]] && chosen == 0,
                ...
                chosen = 1;
                dimlesscoef = caseDerivative[term, originalIV, newIV, newIVDimlessNumber, scalars, vectors, \
                  tensors, closurevar, graddenoters, divdenoters, avgdenoters, derivativedenoters, dotdenoters, tensorproductdenoters, doubledotdenoters, pietrzykflipdenoters, \
                  divform, gradform, normalvecform, Uform, slowIV, fastIV, levelcountdummy, \
                  option];
            ];
            If[Head[term] == Times && chosen == 0,
                ...
                chosen = 1;
                dimlesscoef = caseTimes[term, originalIV, newIV, newIVDimlessNumber, scalars, vectors, tensors, \
                  closurevar, graddenoters, divdenoters, avgdenoters, derivativedenoters, dotdenoters, tensorproductdenoters, doubledotdenoters, pietrzykflipdenoters, divform, \
                  gradform, normalvecform, Uform, slowIV, fastIV, levelcountdummy, option];
            ];
            If[Head[term] == Head[dotdenoters[[1]]] && chosen == 0,
                ...
                chosen = 1;
                dimlesscoef = caseDot[term, originalIV, newIV, newIVDimlessNumber, scalars, vectors, tensors, \
                  closurevar, graddenoters, divdenoters, avgdenoters, derivativedenoters, dotdenoters, tensorproductdenoters, doubledotdenoters, pietrzykflipdenoters, divform, \
                  gradform, normalvecform, Uform, slowIV, fastIV, levelcountdummy, option];
            ];
            If[Head[term] == Head[tensorproductdenoters[[1]]] && chosen == 0,
                ...
                chosen = 1;
                dimlesscoef = caseTensorProduct[term, originalIV, newIV, newIVDimlessNumber, scalars, vectors, \
                  tensors, closurevar, graddenoters, divdenoters, avgdenoters, derivativedenoters, dotdenoters, tensorproductdenoters, doubledotdenoters, pietrzykflipdenoters, \
                  divform, gradform, normalvecform, Uform, slowIV, fastIV, levelcountdummy, \
                  option];
            ];
            If[Head[term] == Head[doubledotdenoters[[1]]] && chosen == 0,
                ...
                chosen = 1;
                dimlesscoef = caseDoubleDot[term, originalIV, newIV, newIVDimlessNumber, scalars, vectors, tensors, \
                  closurevar, graddenoters, divdenoters, avgdenoters, derivativedenoters, dotdenoters, \
                  tensorproductdenoters, doubledotdenoters, pietrzykflipdenoters, divform, gradform, normalvecform, \
            ...
            If[Head[term] == Plus && chosen == 0,
                ...
                chosen = 1;
                dimlesscoef = casePlus[term, originalIV, newIV, newIVDimlessNumber, scalars, vectors, tensors, \
                  closurevar, graddenoters, divdenoters, avgdenoters, derivativedenoters, dotdenoters, tensorproductdenoters, doubledotdenoters, pietrzykflipdenoters, divform, \
                  gradform, normalvecform, Uform, slowIV, fastIV, levelcountdummy, option];
            ];
            If[Head[term] == Head[graddenoters[[1]]] && chosen == 0,
                ...
                chosen = 1;
                dimlesscoef = caseGradient[term, originalIV, newIV, newIVDimlessNumber, scalars, vectors, \
                  tensors, closurevar, graddenoters, divdenoters, avgdenoters, derivativedenoters, dotdenoters, tensorproductdenoters, doubledotdenoters, pietrzykflipdenoters, \
                  divform, gradform, normalvecform, Uform, slowIV, fastIV, levelcountdummy, \
                  option];
            ];
            If[Head[term] == Head[divdenoters[[1]]] && chosen == 0,
                ...
                chosen = 1;
                dimlesscoef = caseDivergence[term, originalIV, newIV, newIVDimlessNumber, scalars, vectors, \
                  tensors, closurevar, graddenoters, divdenoters, avgdenoters, derivativedenoters, dotdenoters, tensorproductdenoters, doubledotdenoters, pietrzykflipdenoters, \
                  divform, gradform, normalvecform, Uform, slowIV, fastIV, levelcountdummy, \
                  option];
            ];
            If[Head[term] == Head[avgdenoters[[1, 1]]] && chosen == 0,
                ...
                chosen = 1;
                dimlesscoef = caseAverage[term, originalIV, newIV, newIVDimlessNumber, scalars, vectors, \
                  tensors, closurevar, graddenoters, divdenoters, avgdenoters, derivativedenoters, dotdenoters, tensorproductdenoters, doubledotdenoters, pietrzykflipdenoters, \
                  divform, gradform, normalvecform, Uform, slowIV, fastIV, levelcountdummy, \
                  option];
            ];
            ...
            If[chosen == 0,
                ...
                dimlesscoef = decider[Head[term], originalIV, newIV, newIVDimlessNumber, scalars, vectors, \
                  tensors, closurevar, graddenoters, divdenoters, avgdenoters, derivativedenoters, dotdenoters, tensorproductdenoters, doubledotdenoters, pietrzykflipdenoters, \
                  divform, gradform, normalvecform, Uform, slowIV, fastIV, levelcountdummy, \
                  dependencies];
            ];
...
(*Ready*)
caseList[term_, originalIV_, newIV_, newIVDimlessNumber_, scalars_, vectors_, tensors_, closurevar_, graddenoters_, \
divdenoters_, avgdenoters_, derivativedenoters_, dotdenoters_, tensorproductdenoters_, doubledotdenoters_, pietrzykflipdenoters_, \
...
(*Ready*)
caseRational[term_, originalIV_, newIV_, newIVDimlessNumber_, scalars_, vectors_, tensors_, closurevar_, graddenoters_, \
divdenoters_, avgdenoters_, derivativedenoters_, dotdenoters_, tensorproductdenoters_, doubledotdenoters_, pietrzykflipdenoters_, \
divform_, gradform_, normalvecform_, Uform_, slowIV_, fastIV_, levelcountdummy_, option_] :=
...
(*Ready*)
caseInteger[term_, originalIV_, newIV_, newIVDimlessNumber_, scalars_, vectors_, tensors_, closurevar_, graddenoters_, \
divdenoters_, avgdenoters_, derivativedenoters_, dotdenoters_, tensorproductdenoters_, doubledotdenoters_, pietrzykflipdenoters_, \
divform_, gradform_, normalvecform_, Uform_, slowIV_, fastIV_, levelcountdummy_, option_] :=
    Block[{dimlesscoef = term},
        Return[dimlesscoef];
...
(*Ready*)
caseSymbol[term_, originalIV_, newIV_, newIVDimlessNumber_, scalars_, vectors_, tensors_, closurevar_, graddenoters_, \
divdenoters_, avgdenoters_, derivativedenoters_, dotdenoters_, tensorproductdenoters_, doubledotdenoters_, pietrzykflipdenoters_, \
divform_, gradform_, normalvecform_, Uform_, slowIV_, fastIV_, levelcountdummy_, option_] :=
    Block[{dimlesscoef},
...
(*Ready*)
casePietrzykFlip[term_, originalIV_, newIV_, newIVDimlessNumber_, scalars_, vectors_, tensors_, closurevar_, graddenoters_, \
divdenoters_, avgdenoters_, derivativedenoters_, dotdenoters_, tensorproductdenoters_, doubledotdenoters_, pietrzykflipdenoters_, \
divform_, gradform_, normalvecform_, Uform_, slowIV_, fastIV_, levelcountdummy_, option_] :=
    ...
    expandedargument, expandedinthepower, bracketeddummy},
        ...
        If[Head[expandedargument] == Plus,
            ...
            For[i = 1, i <= Length[expandedargument], i++,
                bracketeddummy = OperatorApplier[expandedargument[[i]], pietrzykflipdenoters, \
                  superscript];
                dimlesscoef += decider[bracketeddummy, originalIV, newIV, newIVDimlessNumber, scalars, vectors, tensors, \
                  closurevar, graddenoters, divdenoters, avgdenoters, derivativedenoters, dotdenoters, \
                  tensorproductdenoters, doubledotdenoters, pietrzykflipdenoters, divform, gradform, normalvecform, \
                  Uform, slowIV, fastIV, levelcountdummy, option];
            ];
        ...
        inthepower = decider[argument, originalIV, newIV, newIVDimlessNumber, scalars, vectors, \
          tensors, closurevar, graddenoters, divdenoters, avgdenoters, derivativedenoters, dotdenoters, tensorproductdenoters, doubledotdenoters, pietrzykflipdenoters, \
          divform, gradform, normalvecform, Uform, slowIV, fastIV, levelcountdummy, \
          option];
...
(*Ready*)
casePower[term_, originalIV_, newIV_, newIVDimlessNumber_, scalars_, vectors_, tensors_, closurevar_, graddenoters_, \
divdenoters_, avgdenoters_, derivativedenoters_, dotdenoters_, tensorproductdenoters_, doubledotdenoters_, pietrzykflipdenoters_, \
divform_, gradform_, normalvecform_, Uform_, slowIV_, fastIV_, levelcountdummy_, option_] :=
    ...
    dimlesscoefparts, bracketeddummy},
        ...
        If[Head[expandedterm] == Plus,
            ...
            dimlesscoef = decider[expandedterm, originalIV, newIV, newIVDimlessNumber, scalars, vectors, tensors, \
              closurevar, graddenoters, divdenoters, avgdenoters, derivativedenoters, dotdenoters, \
              tensorproductdenoters, doubledotdenoters, pietrzykflipdenoters, divform, gradform, normalvecform, \
              Uform, slowIV, fastIV, levelcountdummy, option];
        ...
        If[Head[expandedinthepower] == Plus,
            dimlesscoef = 0;
            For[i = 1, i <= Length[expandedinthepower], i++,
                dimlesscoef += expandedinthepower[[i]]^power;
            ];
            ,
...
(*Ready*)
caseDerivative[term_, originalIV_, newIV_, newIVDimlessNumber_, scalars_, vectors_, tensors_, closurevar_, graddenoters_, \
...
levelcountdummy_, option_] :=
    ...
    flag = 0, argumentparts, i, j, expandedargument, dimlesscoefparts, bracketeddummy, \
    expandednewargument, IVindex},
        ...
        newargument = decider[argument, originalIV, newIV, newIVDimlessNumber, scalars, vectors, \
          tensors, closurevar, graddenoters, divdenoters, avgdenoters, derivativedenoters, dotdenoters, tensorproductdenoters, doubledotdenoters, pietrzykflipdenoters, \
          divform, gradform, normalvecform, Uform, slowIV, fastIV, levelcountdummy, \
          option];
        
        
        (*Get the index to the subscript*)
        flag = 0;
        For[i = 1, i <= Length[originalIV], i++,
            If[originalIV[[i]] == subscript,
                IVindex = i;
                flag = 1;
                Break[];
            ];
        ...
        If[flag == 0,
            Print["CRITICAL ERROR: " <> functionName <> ": caseDerivative: IV for the derivative taken was not provided in originalIV input. Please specify the unknown IV and its expansion. Term is: ", term];
            Return[Null];
        ];
        ...
        If[Head[expandednewargument] == Plus,
            ...
            For[i = 1, i <= Length[expandednewargument], i++,
                For[j = 1, j <= Length[newIV[[IVindex]]], j++,
                    dimlesscoef += newIVDimlessNumber[[IVindex, j]] * OperatorApplier[expandednewargument[[i]], derivativedenoters, newIV[[IVindex, j]]];
                ];
            ];
            ,
            dimlesscoef = 0;
            For[j = 1, j <= Length[newIV[[IVindex]]], j++,
                dimlesscoef += newIVDimlessNumber[[IVindex, j]] * OperatorApplier[expandednewargument, derivativedenoters, newIV[[IVindex, j]]];
            ];
            ,
            dimlesscoef = 0;
            For[j = 1, j <= Length[newIV[[IVindex]]], j++,
        ...
        dimlesscoef = getterminfo[dimlesscoef, {}, scalars, vectors, tensors, closurevar, graddenoters, \
...
(*Ready*)
caseTimes[term_, originalIV_, newIV_, newIVDimlessNumber_, scalars_, vectors_, tensors_, closurevar_, graddenoters_, \
...
slowIV_, fastIV_, levelcountdummy_, option_] :=
    Block[{dimlesscoef, expandedterm = Expand[term], i, j, newterm},
        ...
        For[i = 1, i <= Length[expandedterm], i++,
            newterm[[i]] = decider[expandedterm[[i]], originalIV, newIV, newIVDimlessNumber, scalars, vectors, \
              tensors, closurevar, graddenoters, divdenoters, avgdenoters, derivativedenoters, dotdenoters, tensorproductdenoters, doubledotdenoters, pietrzykflipdenoters, \
              divform, gradform, normalvecform, Uform, slowIV, fastIV, levelcountdummy, \
              option];
        ];
...
(*Ready*)
caseDot[term_, originalIV_, newIV_, newIVDimlessNumber_, scalars_, vectors_, tensors_, closurevar_, graddenoters_, \
divdenoters_, avgdenoters_, derivativedenoters_, dotdenoters_, tensorproductdenoters_, doubledotdenoters_, pietrzykflipdenoters_, divform_, gradform_, normalvecform_, Uform_, \
slowIV_, fastIV_, levelcountdummy_, option_] :=
    ...
    expandedterm, newtermdotted, newterm},
        ...
        For[i = 1, i <= Nterms, i++,
            newterm[[i]] = decider[term[[i]], originalIV, newIV, newIVDimlessNumber, scalars, vectors, \
              tensors, closurevar, graddenoters, divdenoters, avgdenoters, derivativedenoters, dotdenoters, tensorproductdenoters, doubledotdenoters, pietrzykflipdenoters, \
              divform, gradform, normalvecform, Uform, slowIV, fastIV, levelcountdummy, \
              option];
        ];
        ...
        dimlesscoef = productDistributer[newtermdotted, dotdenoters, originalIV, newIV, newIVDimlessNumber, scalars, vectors, tensors, closurevar, graddenoters, \
...
productDistributer[term_, distributedDenoter_, originalIV_, newIV_, newIVDimlessNumber_, scalars_, vectors_, tensors_, closurevar_, graddenoters_, \
divdenoters_, avgdenoters_, derivativedenoters_, dotdenoters_, tensorproductdenoters_, doubledotdenoters_, pietrzykflipdenoters_, divform_, gradform_, normalvecform_, Uform_, \
slowIV_, fastIV_, levelcountdummy_, option_] :=
            ...
            For[isum = 1, isum <= Nsum, isum++,
                ...
                For[i = 1, i <= Length[term[[isum]]], i++,
                    If[Head[term[[isum, i]]] == Plus,
                        ...
                        dimlesscoef = productDistributer[expandedterm, distributedDenoter, originalIV, newIV, newIVDimlessNumber, scalars, vectors, tensors, \
                          closurevar, graddenoters, divdenoters, avgdenoters, derivativedenoters, dotdenoters, \
                          tensorproductdenoters, doubledotdenoters, pietrzykflipdenoters, divform, gradform, normalvecform, \
                          Uform, slowIV, fastIV, levelcountdummy, option];
...
(*Ready*)
caseTensorProduct[term_, originalIV_, newIV_, newIVDimlessNumber_, scalars_, vectors_, tensors_, closurevar_, graddenoters_, \
divdenoters_, avgdenoters_, derivativedenoters_, dotdenoters_, tensorproductdenoters_, doubledotdenoters_, pietrzykflipdenoters_, \
divform_, gradform_, normalvecform_, Uform_, slowIV_, fastIV_, levelcountdummy_, option_] :=
    ...
    expandedterm, newtermdotted, newterm},
        ...
        For[i = 1, i <= Nterms, i++,
            If[Head[term[[i]]] == Plus,
                ...
                dimlesscoef = decider[expandedterm, originalIV, newIV, newIVDimlessNumber, scalars, vectors, \
                  tensors, closurevar, graddenoters, divdenoters, avgdenoters, derivativedenoters, dotdenoters, tensorproductdenoters, doubledotdenoters, pietrzykflipdenoters, \
                  divform, gradform, normalvecform, Uform, slowIV, fastIV, levelcountdummy, \
                  option];
        ...
        dimlesscoef = productDistributer[newtermdotted, tensorproductdenoters, originalIV, newIV, newIVDimlessNumber, scalars, vectors, tensors, closurevar, graddenoters, \
          divdenoters, avgdenoters, derivativedenoters, dotdenoters, tensorproductdenoters, doubledotdenoters, pietrzykflipdenoters, divform, gradform, normalvecform, Uform, \
          slowIV, fastIV, levelcountdummy, option];
...
(*Ready*)
caseDoubleDot[term_, originalIV_, newIV_, newIVDimlessNumber_, scalars_, vectors_, tensors_, closurevar_, graddenoters_, \
divdenoters_, avgdenoters_, derivativedenoters_, dotdenoters_, tensorproductdenoters_, doubledotdenoters_, pietrzykflipdenoters_, \
divform_, gradform_, normalvecform_, Uform_, slowIV_, fastIV_, levelcountdummy_, option_] :=
    ...
    expandedterm, newtermdotted, newterm},
        ...
        dimlesscoef = productDistributer[newtermdotted, doubledotdenoters, originalIV, newIV, newIVDimlessNumber, scalars, vectors, tensors, closurevar, graddenoters, \
          divdenoters, avgdenoters, derivativedenoters, dotdenoters, tensorproductdenoters, doubledotdenoters, pietrzykflipdenoters, divform, gradform, normalvecform, Uform, \
          slowIV, fastIV, levelcountdummy, option];
...
(*Ready*)
casePlus[term_, originalIV_, newIV_, newIVDimlessNumber_, scalars_, vectors_, tensors_, closurevar_, graddenoters_, \
divdenoters_, avgdenoters_, derivativedenoters_, dotdenoters_, tensorproductdenoters_, doubledotdenoters_, pietrzykflipdenoters_, \
divform_, gradform_, normalvecform_, Uform_, slowIV_, fastIV_, levelcountdummy_, option_] :=
    Block[{dimlesscoef = 0, i},
        
        For[i = 1, i <= Length[term], i++,
            dimlesscoef += decider[term[[i]], originalIV, newIV, newIVDimlessNumber, scalars, vectors, tensors, closurevar, \
              graddenoters, divdenoters, avgdenoters, derivativedenoters, dotdenoters, tensorproductdenoters, doubledotdenoters, pietrzykflipdenoters, divform, gradform, \
...
(*Ready*)
caseGradient[term_, originalIV_, newIV_, newIVDimlessNumber_, scalars_, vectors_, tensors_, closurevar_, graddenoters_, \
divdenoters_, avgdenoters_, derivativedenoters_, dotdenoters_, tensorproductdenoters_, doubledotdenoters_, pietrzykflipdenoters_, \
divform_, gradform_, normalvecform_, Uform_, slowIV_, fastIV_, levelcountdummy_, option_] :=
    Block[{dimlesscoef, argument = term[[1]], subscript = term[[2]], newargument, \
    flag = 0, argumentparts, i, j, expandedargument, dimlesscoefparts, bracketeddummy, \
    expandednewargument, IVindex},
        ...
        newargument = decider[expandedargument, originalIV, newIV, newIVDimlessNumber, scalars, vectors, \
          tensors, closurevar, graddenoters, divdenoters, avgdenoters, derivativedenoters, dotdenoters, tensorproductdenoters, doubledotdenoters, pietrzykflipdenoters, \
          divform, gradform, normalvecform, Uform, slowIV, fastIV, levelcountdummy, \
          option];
        ...
        If[flag == 0,
            Print["CRITICAL ERROR: " <> functionName <> ": caseGradient: IV for the gradient taken was not provided in originalIV input. Please specify the unknown IV and its expansion. Term is: ", term];
            Return[Null];
        ];
        ...
        If[Head[expandednewargument] == Plus,
            ...
            For[i = 1, i <= Length[expandednewargument], i++,
                For[j = 1, j <= Length[newIV[[IVindex]]], j++,
                    dimlesscoef += newIVDimlessNumber[[IVindex, j]] * OperatorApplier[expandednewargument[[i]], graddenoters, newIV[[IVindex, j]]];
                ];
            ];
            ,
            dimlesscoef = 0;
            For[j = 1, j <= Length[newIV[[IVindex]]], j++,
                dimlesscoef += newIVDimlessNumber[[IVindex, j]] * OperatorApplier[expandednewargument, graddenoters, newIV[[IVindex, j]]];
            ];
            ,
            dimlesscoef = 0;
            For[j = 1, j <= Length[newIV[[IVindex]]], j++,
...
(*Ready*)
caseDivergence[term_, originalIV_, newIV_, newIVDimlessNumber_, scalars_, vectors_, tensors_, closurevar_, graddenoters_, \
divdenoters_, avgdenoters_, derivativedenoters_, dotdenoters_, tensorproductdenoters_, doubledotdenoters_, pietrzykflipdenoters_, divform_, gradform_, normalvecform_, Uform_, \
slowIV_, fastIV_, levelcountdummy_, option_] :=
    Block[{dimlesscoef, argument = term[[1]], subscript = term[[2]], newargument, \
    flag = 0, argumentparts, i, j, expandedargument, bracketeddummy, \
    expandednewargument, IVindex},
        ...
        If[flag == 0,
            Print["CRITICAL ERROR: " <> functionName <> ": caseDivergence: IV for the divergence taken was not provided in originalIV input. Please specify the unknown IV and its expansion. Term is: ", term];
            Return[Null];
        ];
        ...
        If[Head[expandednewargument] == Plus,
            ...
            For[i = 1, i <= Length[expandednewargument], i++,
                For[j = 1, j <= Length[newIV[[IVindex]]], j++,
                    dimlesscoef += newIVDimlessNumber[[IVindex, j]] * OperatorApplier[expandednewargument[[i]], divdenoters, newIV[[IVindex, j]]];
                ];
            ];
            ,
            dimlesscoef = 0;
            For[j = 1, j <= Length[newIV[[IVindex]]], j++,
                dimlesscoef += newIVDimlessNumber[[IVindex, j]] * OperatorApplier[expandednewargument, divdenoters, newIV[[IVindex, j]]];
            ];
            ,
            dimlesscoef = 0;
            For[j = 1, j <= Length[newIV[[IVindex]]], j++,
...
(*Ready*)
caseAverage[term_, originalIV_, newIV_, newIVDimlessNumber_, scalars_, vectors_, tensors_, closurevar_, graddenoters_, \
divdenoters_, avgdenoters_, derivativedenoters_, dotdenoters_, tensorproductdenoters_, doubledotdenoters_, pietrzykflipdenoters_, divform_, gradform_, normalvecform_, Uform_, \
slowIV_, fastIV_, levelcountdummy_, option_] :=
    ...
    dropindices = {}},
        ...
        If[camebackSum == 1,
            ...
            For[i = 1, i <= Length[dimlesscoef[[1, 2, 1]]], i++,
                ...
                (*After collecting all simplified dotted components, move the scalars
                  out of the dot product. This is where the scalars are identified.*)
            ...
            (*After collecting all simplified dotted components, move the scalars
              out of the dot product.This is where they are moved.*)
